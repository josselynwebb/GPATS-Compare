...
Public Module CiclLib
    ...
    Declare Function atxml_IssueIst Lib "AtXmlApi.dll" (ByVal InstSefTest As String, ByVal Response As String, ByVal BufferSize As Integer) As Integer
    ...
    'Declare Function viOpenDefaultRM Lib "AtXmlDriverFunc.dll"
    '                        (ByVal ResourceName As String,
    '                         ByVal vi As Long) As Long

    'Declare Function viFindNext Lib "AtXmlDriverFunc.dll"
    '                        (ByVal ResourceName As String,
    '                         ByVal desc As String) As Long

    'Declare Function viFindRsrc Lib "AtXmlDriverFunc.dll"
    '                        (ByVal ResourceName As String,
    '                         ByVal sesn As Long,
    '                         ByVal InstrumentCmds As String,
    '                         vi As Long,
    '                         retCount As Long,
    '                         ByVal desc As String) As Long
    ...
    Public Const VI_TMO_INFINITE As Integer = &HFFFF
    Public Const VI_INFINITE As Integer = &HFFFF
