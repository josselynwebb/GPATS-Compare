...
Public Module CiclLib
    ...
    '------------------------------------------------------------
    '2017new functions to support atxml on TETS RF
    ...
    Declare Function atxmlDF_rf_measfreq Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByVal expectedfreq As Double, ByVal attn As Integer, ByRef measfreq As Double) As Integer
    Declare Function atxmlDF_rf_peaktune Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByRef measfreq As Double, ByVal attn As Integer) As Integer
    Declare Function atxmlDF_rf_measpw Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByVal carrierfreq As Double, ByVal expectedpw As Double, ByVal attn As Integer, ByRef measpw As Double) As Integer
    Declare Function atxmlDF_rf_measpd Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByVal carrierfreq As Double, ByVal expectedpw As Double, ByVal attn As Integer, ByRef measpd As Double) As Integer
    Declare Function atxmlDF_eip1315a_setLO Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByVal frequency As Double, ByVal mode As Short, ByVal attn As Integer, ByVal IFDET As Short) As Integer
    Declare Function atxmlDF_gt55210a_setLO Lib "AtxmlDriverFunc.dll" _
        (ByVal resourceName As String, ByVal MHz As Double, ByVal mode As Short, ByVal attn As Integer, ByVal IFDET As Integer) As Integer
