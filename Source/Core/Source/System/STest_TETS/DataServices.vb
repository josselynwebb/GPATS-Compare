...
Public Module DataServices
    ...
    Public Sub EndData()
        ...
        ''Dim nStatus As Integer 'Pass/Fail Status
        ''Dim sCallout As String 'Fault Callout Field Value
        ...
        '  StopTime As String,
        '  ERO As String,
        '  TPCCN As String,             "SELF-TEST"
        '  UUTSerialNumber As String,
        '  UUTRevision As String,
        '  IDSerialNumber As String,
        '  TestStatus As Long,
        '  FailureStep As String,
        '  FaultCallout As String,
        '  MeasuredValue As Double,
        '  Dimension As String,
        '  UpperLimit As Double,
        '  LowerLimit As Double,
        '  OperatorComments As String
        ')As Long
    ...
    Sub WriteData(sStart_Time As String, Optional sStop_Time As String = "#12:00:00 AM#", Optional lTest_Status As Integer = 0, Optional sFailure_Step As String = "", Optional sFault_Callout As String = "", Optional dMeas_Value As Double = 0, Optional sDimension As String = "", Optional dUpper_Limit As Double = 0, Optional dLower_Limit As Double = 0, Optional sOperator_Comments As String = "")
        '********************************************************************************
        ...
        nErrCode = objData.SaveData(sStart_Time, sStop_Time, sERO, sTPCCN, sUUT_Serial_No, sUUT_Rev, sID_Serial_No, lTest_Status, sFailure_Step, sFault_Callout, dMeas_Value, sDimension, dUpper_Limit, dLower_Limit, sOperator_Comments)
