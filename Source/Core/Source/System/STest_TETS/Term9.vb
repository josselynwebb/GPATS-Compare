...
Public Module terM9bas
    ...
    '* Purpose        : This module contains definitions for      *
    '*                  the Teradyne M910 Digital Self Test       *
    '**************************************************************
    '
    ...
    ' M90301.05 31-Jul-97 10:45:20    tpl    Remove setResultIndex,set/getProbe add parameters to some prepareprobe functions
    ' M90205    08-Jul-97 11:36:00    yae    Realigning with the latest revs of terM9.h
    ' M90204    03-Jul-97 10:46:00    aam    Realigning with the latest revs for the FCS DLL
    ...
    'Declare Function terM9_getChannel Lib "terM9_32.dll" (ByVal vi As Integer, ByVal scopeIdx As Integer, ByRef Capture As Integer, ByRef chanMode As Integer, ByRef connect As Integer, ByRef Format As Integer, ByRef impedance As Integer, ByRef LevelIdx As Integer, ByRef Load As Integer, ByRef PhaseIdx As Integer, ByRef WindowIdx As Integer) As Integer
    ...
    'Declare Function terM9_getChannelFormat Lib "terM9_32.dll" (ByVal vi As Integer, ByVal scopeIdx As Integer, ByRef Format As Integer) As Integer
    ...
    'Declare Function terM9_setChannel Lib "terM9_32.dll" (ByVal vi As Integer, ByVal pinListCount As Integer, ByRef pinList As Integer, ByVal Capture As Integer, ByVal chanMode As Integer, ByVal connect As Integer, ByVal Format As Integer, ByVal impedance As Integer, ByVal LevelIdx As Integer, ByVal Load As Integer, ByVal PhaseIdx As Integer, ByVal WindowIdx As Integer) As Integer
    ...
    'Declare Function terM9_setChannelFormat Lib "terM9_32.dll" (ByVal vi As Integer, ByVal pinListCount As Integer, ByRef pinList As Integer, ByVal Format As Integer) As Integer
    ...
    Declare Function terM9_loadDynamicPattern Lib "terM9_32.dll" (ByVal vi As Integer, ByVal mstep As Short, ByVal TEST As Short) As Integer
    ...
    'Declare Function terM9_prepareDynamicPatternSet Lib "terM9_32.dll" (ByVal vi As Integer) As Object
    ...
    Declare Function terM9_runStaticPattern Lib "terM9_32.dll" (ByVal vi As Integer, ByVal mstep As Short, ByVal TEST As Short) As Integer
    ...
    'Declare Function terM9_revisionQuery Lib "terM9_32.dll" (ByVal vi As Integer, ByVal driverRev As String, ByVal instrRev As String) As Integer
    'Declare Function terM9_revision_query Lib "terM9_32.dll" (ByVal vi As Integer, ByVal driverRev As String, ByVal instrRev As String) As Integer
    ...
    Declare Function terM9_waitForProbeButton Lib "terM9_32.dll" (ByVal vi As Integer, ByVal timeout As Double) As Integer
    Declare Function terM9_initiateProbeButton Lib "terM9_32.dll" (ByVal vi As Integer) As Integer
    Declare Function terM9_stopProbeButton Lib "terM9_32.dll" (ByVal vi As Integer) As Integer
    'Declare Function terM9_fetchInterruptState Lib "terM9_32.dll" (ByVal vi As Integer, ByVal interrupt As Integer, ByRef state As Short) As Integer
    ...
    Public Const TERM9_ERROR_PROBE_TIMEOUT As Integer = &HBFFC08D0
    ...
    Public Const TERM9_ATTRVAL_FIRST As Integer = 2
    Public Const TERM9_ADC_CONN_10TO10 As Integer = 2
    Public Const TERM9_ADC_CONN_12MINUS As Integer = 3
    Public Const TERM9_ADC_CONN_12PLUS As Integer = 4
    Public Const TERM9_ADC_CONN_3PLUS As Integer = 5
    Public Const TERM9_ADC_CONN_20TO20 As Integer = 6
    Public Const TERM9_ADC_CONN_24MINUS As Integer = 7
    Public Const TERM9_ADC_CONN_24PLUS As Integer = 8
    Public Const TERM9_ADC_CONN_5TO5 As Integer = 9
    Public Const TERM9_ADC_CONN_AMMETER As Integer = 10
    Public Const TERM9_ADC_CONN_PWRGND As Integer = 11
    Public Const TERM9_ADC_CONN_SIGGND As Integer = 12
    Public Const TERM9_ADC_CONN_VCC As Integer = 13
    Public Const TERM9_ADC_CONN_VEE As Integer = 14
    Public Const TERM9_ADC_CONN_VTT As Integer = 15
    Public Const TERM9_ADC_CONN_UNKNOWN As Integer = 16
    Public Const TERM9_AMMTR_MODE_FORCE As Integer = 17
    Public Const TERM9_AMMTR_MODE_MEASURE As Integer = 18
    Public Const TERM9_AMMTR_MODE_OFF As Integer = 19
    Public Const TERM9_AMMTR_MODE_SELFTEST As Integer = 20
    Public Const TERM9_AMMTR_MODE_UNKNOWN As Integer = 21
    Public Const TERM9_PATTERNSET_LEARN_FAILS As Integer = 22
    Public Const TERM9_PATTERNSET_LEARN_PATS As Integer = 23
    Public Const TERM9_PATTERNSET_PRECOUNT_FAILS As Integer = 24
    Public Const TERM9_PATTERNSET_PRECOUNT_PATS As Integer = 25
    Public Const TERM9_CAPTURE_CLOSE As Integer = 26
    Public Const TERM9_CAPTURE_OPEN As Integer = 27
    Public Const TERM9_CAPTURE_WINDOW As Integer = 28
    Public Const TERM9_CHANMODE_DYNAMIC As Integer = 29
    Public Const TERM9_CHANMODE_STATIC As Integer = 30
    Public Const TERM9_CLUTCH_INPUT_HIGH As Integer = 31
    Public Const TERM9_CLUTCH_SIGNAL_HIGH As Integer = 32
    Public Const TERM9_CLUTCH_INPUT_LOW As Integer = 33
    Public Const TERM9_CLUTCH_SIGNAL_LOW As Integer = 34
    Public Const TERM9_COND_ALWAYS As Integer = 35
    Public Const TERM9_COND_TRUE As Integer = 35
    Public Const TERM9_COND_EX1 As Integer = 36
    Public Const TERM9_COND_EXT1 As Integer = 36
    Public Const TERM9_COND_EX2 As Integer = 37
    Public Const TERM9_COND_EXT2 As Integer = 37
    Public Const TERM9_COND_FAIL As Integer = 38
    Public Const TERM9_COND_NEVER As Integer = 39
    Public Const TERM9_COND_FALSE As Integer = 39
    Public Const TERM9_COND_PASS As Integer = 40
    Public Const TERM9_COND_SYNC As Integer = 41
    Public Const TERM9_COND_NONE As Integer = 42
    Public Const TERM9_COP_CLOOP As Integer = 43
    Public Const TERM9_COP_CREPEAT As Integer = 44
    Public Const TERM9_COP_ENDLOOP As Integer = 45
    Public Const TERM9_COP_HALT As Integer = 46
    Public Const TERM9_COP_JUMP As Integer = 47
    Public Const TERM9_COP_LOOP As Integer = 48
    Public Const TERM9_COP_NOP As Integer = 49
    Public Const TERM9_COP_REPEAT As Integer = 50
    Public Const TERM9_DETECTOR_BETWEEN As Integer = 51
    Public Const TERM9_DETECTOR_HIGH As Integer = 52
    Public Const TERM9_DETECTOR_LOW As Integer = 53
    Public Const TERM9_DETECTOR_UNKNOWN As Integer = 54
    Public Const TERM9_EDGE_FALLING As Integer = 55
    Public Const TERM9_EDGE_RISING As Integer = 56
    Public Const TERM9_EXECUTE_COMPARE As Integer = 57
    Public Const TERM9_EXECUTE_LEARN As Integer = 58
    Public Const TERM9_FORMAT_COMPS As Integer = 59
    Public Const TERM9_FORMAT_NRET As Integer = 60
    Public Const TERM9_FORMAT_RCOMP As Integer = 61
    Public Const TERM9_FORMAT_ROFF As Integer = 62
    Public Const TERM9_FORMAT_RONE As Integer = 63
    Public Const TERM9_FORMAT_RZERO As Integer = 64
    Public Const TERM9_GROUND_EXTERNAL As Integer = 65
    Public Const TERM9_GROUND_INTERNAL As Integer = 66
    Public Const TERM9_IMPED_50OHM As Integer = 67
    Public Const TERM9_IMPED_LOWZ As Integer = 68
    Public Const TERM9_LOAD_OFF As Integer = 69
    Public Const TERM9_LOAD_ON As Integer = 70
    Public Const TERM9_LOGIC_ECL As Integer = 71
    Public Const TERM9_LOGIC_TTL As Integer = 72
    Public Const TERM9_LOOP_OK As Integer = 73
    Public Const TERM9_LOOP_OVERFLOW As Integer = 74
    Public Const TERM9_LOOP_UNDERFLOW As Integer = 75
    Public Const TERM9_CLOCKMODE_OFF As Integer = 76
    Public Const TERM9_HVPINMODE_OFF As Integer = 77
    Public Const TERM9_UCLKMODE_OFF As Integer = 78
    Public Const TERM9_CLOCKMODE_ON As Integer = 79
    Public Const TERM9_HVPINMODE_ON As Integer = 80
    Public Const TERM9_UCLKMODE_ON As Integer = 81
    Public Const TERM9_MTR_INPUT_NONE As Integer = 82
    Public Const TERM9_MTR_INPUT_PANEL As Integer = 83
    Public Const TERM9_MTR_INPUT_STMTX As Integer = 84
    Public Const TERM9_MTR_INPUT_UNKNOWN As Integer = 85
    Public Const TERM9_MTR_IRNG_100MA As Integer = 86
    Public Const TERM9_MTR_IRNG_10MA As Integer = 87
    Public Const TERM9_MTR_IRNG_UNKNOWN As Integer = 88
    Public Const TERM9_MTR_MODE_FORCE As Integer = 89
    Public Const TERM9_MTR_MODE_MEASURE As Integer = 90
    Public Const TERM9_MTR_MODE_OFF As Integer = 91
    Public Const TERM9_MTR_MODE_SELFTEST As Integer = 92
    Public Const TERM9_MTR_MODE_UNKNOWN As Integer = 93
    Public Const TERM9_MTR_VRNG_10TO10 As Integer = 94
    Public Const TERM9_MTR_VRNG_20TO20 As Integer = 95
    Public Const TERM9_MTR_VRNG_5TO5 As Integer = 96
    Public Const TERM9_MTR_VRNG_OFF As Integer = 97
    Public Const TERM9_OP_SIG As Integer = 98
    Public Const TERM9_OP_CRC As Integer = 98
    Public Const TERM9_OP_IH As Integer = 99
    Public Const TERM9_OP_IHOL As Integer = 100
    Public Const TERM9_OP_IL As Integer = 101
    Public Const TERM9_OP_ILOH As Integer = 102
    Public Const TERM9_OP_IOX As Integer = 103
    Public Const TERM9_OP_IX As Integer = 104
    Public Const TERM9_OP_KEEP As Integer = 105
    Public Const TERM9_OP_MH As Integer = 106
    Public Const TERM9_OP_ML As Integer = 107
    Public Const TERM9_OP_MX As Integer = 108
    Public Const TERM9_OP_OB As Integer = 109
    Public Const TERM9_OP_OH As Integer = 110
    Public Const TERM9_OP_OK As Integer = 111
    Public Const TERM9_OP_OL As Integer = 112
    Public Const TERM9_OP_OX As Integer = 113
    Public Const TERM9_OP_TOG As Integer = 114
    Public Const TERM9_OP_GROUP_UNKNOWN As Integer = 115
    Public Const TERM9_OP_UNKNOWN As Integer = 116
    Public Const TERM9_PATH_DISABLE As Integer = 117
    Public Const TERM9_PATH_ENABLE As Integer = 118
    Public Const TERM9_PRB_B As Integer = 119
    Public Const TERM9_PRB_EH As Integer = 120
    Public Const TERM9_PRB_EL As Integer = 121
    Public Const TERM9_PRB_GB As Integer = 122
    Public Const TERM9_PRB_GH As Integer = 123
    Public Const TERM9_PRB_GL As Integer = 124
    Public Const TERM9_PRB_H As Integer = 125
    Public Const TERM9_PRB_ILLEGAL As Integer = 126
    Public Const TERM9_PRB_L As Integer = 127
    Public Const TERM9_PRB_MB As Integer = 128
    Public Const TERM9_PROBE_METHOD_HANDLE As Integer = 129
    Public Const TERM9_PRB_METHOD_HANDLE As Integer = 129
    Public Const TERM9_PROBE_METHOD_MATRIX As Integer = 130
    Public Const TERM9_PRB_METHOD_MATRIX As Integer = 130
    Public Const TERM9_PROBE_METHOD_UNKNOWN As Integer = 131
    Public Const TERM9_PRB_METHOD_UNKNOWN As Integer = 131
    Public Const TERM9_PRB_MH As Integer = 132
    Public Const TERM9_PRB_ML As Integer = 133
    Public Const TERM9_PRB_PB As Integer = 134
    Public Const TERM9_PRB_PH As Integer = 135
    Public Const TERM9_PRB_PL As Integer = 136
    Public Const TERM9_PRB_RB As Integer = 137
    Public Const TERM9_PRB_RH As Integer = 138
    Public Const TERM9_PRB_RL As Integer = 139
    Public Const TERM9_PRB_X As Integer = 140
    Public Const TERM9_PROBE_CAPTURE_STROBE As Integer = 141
    Public Const TERM9_PROBE_CAPTURE_WINDOW As Integer = 142
    Public Const TERM9_PROBE_CONFIG_LOAD As Integer = 143
    Public Const TERM9_PROBE_CONFIG_RUN As Integer = 144
    Public Const TERM9_PROBEMODE_DYNAMIC As Integer = 145
    Public Const TERM9_PROBEMODE_STATIC As Integer = 146
    Public Const TERM9_PS_CRC As Integer = 147
    Public Const TERM9_PS_SIG As Integer = 147
    Public Const TERM9_PS_IH As Integer = 148
    Public Const TERM9_PS_IHOL As Integer = 149
    Public Const TERM9_PS_IL As Integer = 150
    Public Const TERM9_PS_ILOH As Integer = 151
    Public Const TERM9_PS_IOX As Integer = 152
    Public Const TERM9_PS_MH As Integer = 153
    Public Const TERM9_PS_ML As Integer = 154
    Public Const TERM9_PS_OB As Integer = 155
    Public Const TERM9_PS_OH As Integer = 156
    Public Const TERM9_PS_OK As Integer = 157
    Public Const TERM9_PS_OL As Integer = 158
    Public Const TERM9_PS_UNKNOWN As Integer = 159
    Public Const TERM9_RELAY_CLOSED As Integer = 160
    Public Const TERM9_RELAY_OPEN As Integer = 161
    Public Const TERM9_RESULT_FAIL As Integer = 162
    Public Const TERM9_RESULT_MBT As Integer = 163
    Public Const TERM9_RESULT_NOT_RUN As Integer = 164
    Public Const TERM9_RESULT_OVERFLOW As Integer = 165
    Public Const TERM9_RESULT_PASS As Integer = 166
    Public Const TERM9_RESULT_UNDERFLOW As Integer = 167
    Public Const TERM9_RUN_IDLE As Integer = 168
    Public Const TERM9_RUN_RUNNING As Integer = 169
    Public Const TERM9_RUN_STOPPING As Integer = 170
    Public Const TERM9_SLEWRATE_HIGH As Integer = 171
    Public Const TERM9_SLEWRATE_LOW As Integer = 172
    Public Const TERM9_SLEWRATE_MEDIUM As Integer = 173
    Public Const TERM9_SOURCE_EXTERNAL As Integer = 174
    Public Const TERM9_SOURCE_INTERNAL As Integer = 175
    Public Const TERM9_STATE_HIGH As Integer = 176
    Public Const TERM9_STATE_LOW As Integer = 177
    Public Const TERM9_STMTX_GLOBAL As Integer = 178
    Public Const TERM9_STMTX_LOCAL As Integer = 179
    Public Const TERM9_SYNC_IDLE As Integer = 180
    Public Const TERM9_SYNC_LISTEN As Integer = 181
    Public Const TERM9_SYNC_TRIGGER As Integer = 182
    Public Const TERM9_TIMING_SLOW As Integer = 184
    Public Const TERM9_TIMING_STANDARD As Integer = 185
    Public Const TERM9_TRIGGER_PATCLK As Integer = 186
    Public Const TERM9_TRIGGER_SYSCLK As Integer = 187
    Public Const TERM9_UCLK_TRIGGER_EXTCLK As Integer = 188
    Public Const TERM9_UCLK_TRIGGER_SYSCLK As Integer = 189
    Public Const TERM9_INT_PROBE_BUTTON As Integer = 202
    Public Const TERM9_EDGE_BOTH As Integer = 206
    Public Const TERM9_PATTERNSET_LEARN_UNKNOWN As Integer = 207
    Public Const TERM9_PATTERNSET_PRECOUNT_UNKNOWN As Integer = 208
    Public Const TERM9_FORMAT_UNKNOWN As Integer = 209
    Public Const TERM9_COND_UNKNOWN As Integer = 210
    Public Const TERM9_COP_UNKNOWN As Integer = 211
    Public Const TERM9_SLEWRATE_UNKNOWN As Integer = 212
    Public Const TERM9_SYNC_UNKNOWN As Integer = 213
    Public Const TERM9_ADC_CONN_PRBHNDL As Integer = 214
    Public Const TERM9_ADC_CONN_REFV As Integer = 215
    Public Const TERM9_ATTRVAL_LAST As Integer = 215
    Public Const TERM9_INT_SYSTEM_GROUND As Integer = 222

    ' terM9_scope.h

    Public Const TERM9_SCOPE_LAST As Integer = 65535
    Public Const TERM9_SCOPE_FIRST_USER As Integer = 0
    ...
    Public Const TERM9_SCOPE_UNDEFINED As Integer = -1
    Public Const TERM9_SCOPE_ISGROUP As Integer = -2
...
'#Const defUse_TERM9_SCOPE_CARD = True
#If defUse_TERM9_SCOPE_CARD Then
...
'#Const defUse_TERM9_SCOPE_CHANCARD = True
#If defUse_TERM9_SCOPE_CHANCARD Then
