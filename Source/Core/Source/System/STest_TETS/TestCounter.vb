...
CT1:    '** Perform a COUNTER Power-up Built-In Test
        ...
        'W15-20:  CABLE ASSY, BNC MALE TO BNC MALE
Step1:
...
Step2:
        ...
        S &= "    C/T ARM IN   to   ARB MARKER OUT. "
        DisplaySetup(S, "TETS AMO_CAI.jpg", 1, True, 2, 2)
        If AbortTest = True Then GoTo testcomplete
...
CT2:    'Generate 1 MHz sine wave with 1VPP
        ...
        If dMeasurement < 950000 Or dMeasurement > 1050000 Then
            ...
            If (OptionFaultMode = SOFmode) And (OptionMode <> LOSmode) Then
                ...
                S = "Move the W15 connection from   " & vbCrLf & vbCrLf
...
CT16:   'C/T-16-001 Time Interval Test
        ...
        If (dMeasurement > 0.00000053) Or (dMeasurement < 0.00000045) Then
            ...
            If (OptionFaultMode = SOFmode) And (OptionMode <> LOSmode) Then
                ...
                " in the ATS-TETS Calibration Program may correct this problem.", vbInformation)
                '=============================================================================================
            End If
            If OptionFaultMode = SOFmode Then GoTo TestComplete
        Else
...
CT20:   'C/T-20-001
        ...
        'The following procedures are performed to make measurements using the first positive edge of the arm input
        ...
        If (dMeasurement > 1050000) Or (dMeasurement < 950000) Then
            ...
            If (OptionFaultMode = SOFmode) And (OptionMode <> LOSmode) Then
                dFH_Meas = dMeasurement
                S = "Move the W16 connection from   " & vbCrLf & vbCrLf
                S &= "    C/T ARM IN   to   SCOPE INPUT 1. "
                ...
                Else
                    'C/T-20-D03
                    Echo("C/T-20-D03     ARB Marker Out Diagnostic Test")
                    RegisterFailure(ARB, ReturnTestNumber(COUNTER, 20, 3, "D"), dFH_Meas, "Hz", 950000, 1050000, "ARB Marker Out Diagnostic Test")
                    TestCT = ARB
                End If
            End If
            If OptionFaultMode = SOFmode Then GoTo TestComplete
        ...
        S = "Move the W15 connection from   " & vbCrLf & vbCrLf
        S &= "     C/T INPUT 1   to   C/T INPUT 2. "
        DisplaySetup(S, "TETS AOP_CI2.jpg", 1)
        If AbortTest = True Then GoTo testcomplete
