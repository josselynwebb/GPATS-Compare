...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        'MessageBox.Show("STEST", "DEBUG", MessageBoxButtons.OK) ' leave for debugging
        ...
        Me.imlButtons.Images.SetKeyName(22, "RF Stimulus")
        Me.imlButtons.Images.SetKeyName(23, "RF Measure")
        Me.imlButtons.Images.SetKeyName(24, "VCC")
        Me.imlButtons.Images.SetKeyName(25, "VEO2")
        '
        'InstrumentLabel_0
        '
        ...
        Me.sscTest_23.ImageKey = "RF Measure"
        ...
        Me.ToolTip1.SetToolTip(Me.sscTest_23, "Start RFMEAS Test")
        ...
        Me.ToolTip1.SetToolTip(Me.sscTest_24, "Start VCC Test")
        ...
        Me.ToolTip1.SetToolTip(Me.sscTest_25, "Start VEO2 Test")
        ...
        Me.sscTest_22.ImageKey = "RF Stimulus"
        ...
        Me.InstrumentLabel_13.Size = New System.Drawing.Size(256, 17)
        ...
        Me.InstrumentLabel_14.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_15.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_16.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_17.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_18.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_19.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_21.Text = "RF Power Meter (SC Slot 7)"
        '
        'PassFrame_7
        '
        ...
        Me.InstrumentLabel_22.Text = "RF Synthesizer (SC Slots 4-6)"
        '
        'PassFrame_8
        '
        ...
        Me.InstrumentLabel_23.Text = "RF Measure (SC Slots 7-9)"
        '
        'PassFrame_9
        '
        ...
        Me.InstrumentLabel_20.Size = New System.Drawing.Size(252, 17)
        ...
        Me.InstrumentLabel_25.Size = New System.Drawing.Size(252, 17)
        Me.InstrumentLabel_25.TabIndex = 117
        Me.InstrumentLabel_25.Text = "VEO2"
        '
        'PassFrame_12
        '
        ...
        Me.InstrumentLabel_24.Size = New System.Drawing.Size(252, 17)
        Me.InstrumentLabel_24.TabIndex = 111
        Me.InstrumentLabel_24.Text = "Video Capture Module (CIC Slot 9)"
        '
        'PassFrame_11
        '
...
#End Region
    ...
    Private Sub CmbSelectTest_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSelectTest.SelectedIndexChanged
        ...
        ' This fills the cmdSelectStep combo box based on the particular Test
        HelpContextID = 1010
        ...
        Select Case OptionTestName
            ...
            Case "LF1 Switch"
                ...
                For i = 1 To 34 : cmbSelectStep.Items.Add("LF1-02-" & Format(i, "000")) : Next i
                For i = 1 To 22 : cmbSelectStep.Items.Add("LF1-03-" & Format(i, "000")) : Next i
                For i = 1 To 9 : cmbSelectStep.Items.Add("LF1-04-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("LF1-05-" & Format(i, "000")) : Next i
                For i = 1 To 7 : cmbSelectStep.Items.Add("LF1-06-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("LF1-07-" & Format(i, "000")) : Next i
                For i = 1 To 12 : cmbSelectStep.Items.Add("LF1-08-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF1-09-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF1-10-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF1-11-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF1-12-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF1-13-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF1-14-" & Format(i, "000")) : Next i
                For i = 1 To 16 : cmbSelectStep.Items.Add("LF1-15-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF1-16-" & Format(i, "000")) : Next i

            Case "LF2 Switch"
                For i = 1 To 2 : cmbSelectStep.Items.Add("LF2-01-" & Format(i, "000")) : Next i
                For i = 1 To 34 : cmbSelectStep.Items.Add("LF2-02-" & Format(i, "000")) : Next i
                For i = 1 To 22 : cmbSelectStep.Items.Add("LF2-03-" & Format(i, "000")) : Next i
                For i = 1 To 9 : cmbSelectStep.Items.Add("LF2-04-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("LF2-05-" & Format(i, "000")) : Next i
                For i = 1 To 7 : cmbSelectStep.Items.Add("LF2-06-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("LF2-07-" & Format(i, "000")) : Next i
                For i = 1 To 12 : cmbSelectStep.Items.Add("LF2-08-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF2-09-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF2-10-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF2-11-" & Format(i, "000")) : Next i
                For i = 1 To 10 : cmbSelectStep.Items.Add("LF2-12-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF2-13-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF2-14-" & Format(i, "000")) : Next i
                For i = 1 To 16 : cmbSelectStep.Items.Add("LF2-15-" & Format(i, "000")) : Next i
                For i = 1 To 4 : cmbSelectStep.Items.Add("LF2-16-" & Format(i, "000")) : Next i
            ...
            Case "LF3 Switch"
                ...
                For i = 1 To 25 : cmbSelectStep.Items.Add("LF3-03-" & Format(i, "000")) : Next i
                For i = 1 To 25 : cmbSelectStep.Items.Add("LF3-04-" & Format(i, "000")) : Next i
                For i = 1 To 25 : cmbSelectStep.Items.Add("LF3-05-" & Format(i, "000")) : Next i
                For i = 1 To 25 : cmbSelectStep.Items.Add("LF3-06-" & Format(i, "000")) : Next i
                For i = 1 To 25 : cmbSelectStep.Items.Add("LF3-07-" & Format(i, "000")) : Next i

            Case "MF Switch"
                For i = 1 To 18 : cmbSelectStep.Items.Add("MF-01-" & Format(i, "000")) : Next i
                For i = 1 To 24 : cmbSelectStep.Items.Add("MF-02-" & Format(i, "000")) : Next i
                For i = 1 To 24 : cmbSelectStep.Items.Add("MF-03-" & Format(i, "000")) : Next i

            Case "HF Switch"
                For i = 1 To 12 : cmbSelectStep.Items.Add("HFS-01-" & Format(i, "000")) : Next i
            ...
            Case "Analog Probe" ' no looping on step

            Case "RF PM"
                For i = 1 To 5 : cmbSelectStep.Items.Add("RFP-0" & Format(i, "0") & "-001") : Next i

            Case "RF STIM"
                For i = 1 To 4 : cmbSelectStep.Items.Add("RFS-01-" & Format(i, "000")) : Next i
                For i = 1 To 12 : cmbSelectStep.Items.Add("RFS-02-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("RFS-03-001")
                cmbSelectStep.Items.Add("RFS-04-001")
                cmbSelectStep.Items.Add("RFS-04-002")
                For i = 1 To 2 : cmbSelectStep.Items.Add("RFS-05-" & Format(i, "000")) : Next i
                For i = 1 To 2 : cmbSelectStep.Items.Add("RFS-06-" & Format(i, "000")) : Next i
                For i = 1 To 2 : cmbSelectStep.Items.Add("RFS-07-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("RFS-08-001")

            Case "RF MA"
                cmbSelectStep.Items.Add("RFM-01-001")
                For i = 1 To 6 : cmbSelectStep.Items.Add("RFM-02-" & Format(i, "000")) : Next i
                For i = 1 To 6 : cmbSelectStep.Items.Add("RFM-03-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("RFM-04-001")
                cmbSelectStep.Items.Add("RFM-05-001")
                For i = 1 To 4 : cmbSelectStep.Items.Add("RFM-06-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("RFM-07-001")
                For i = 1 To 4 : cmbSelectStep.Items.Add("APR-0" & Format(i, "0") & "-001") : Next i

            Case "VCC"
                cmbSelectStep.Items.Add("VCC-01-001")
                cmbSelectStep.Items.Add("VCC-02-001")

            Case "VEO2"
                'Note: no looping on power up tests VEO-00-001 to 004
                cmbSelectStep.Items.Add("VEO-01-001")
                For i = 1 To 3 : cmbSelectStep.Items.Add("VEO-02-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("VEO-03-" & Format(i, "000")) : Next i
                For i = 1 To 17 : cmbSelectStep.Items.Add("VEO-04-" & Format(i, "000")) : Next i
                For i = 1 To 3 : cmbSelectStep.Items.Add("VEO-05-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("VEO-06-001 to 003")
                cmbSelectStep.Items.Add("VEO-06-004 to 006")
                cmbSelectStep.Items.Add("VEO-06-007 to 009")
                cmbSelectStep.Items.Add("VEO-07-001 to 003")
                cmbSelectStep.Items.Add("VEO-07-004 to 006")
                cmbSelectStep.Items.Add("VEO-07-007")
                cmbSelectStep.Items.Add("VEO-07-008")
                For i = 1 To 6 : cmbSelectStep.Items.Add("VEO-08-" & Format(i, "000")) : Next i
                cmbSelectStep.Items.Add("VEO-09-001")
                For i = 1 To 2 : cmbSelectStep.Items.Add("VEO-10-" & Format(i, "000")) : Next i
        End Select
    ...
    Private Sub CmdClose_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles cmdClose.MouseDown
        ...
        s = s & "Note: SP3 at CIC J5 can cause the ATS to restart after power down."
    ...
    Private Sub frmSTest_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If KeyCode = key_F1 Then            ' help?
            ...
            If Dir(ProgramPath & "Stest1.chm", 17) <> "" Then
                If HelpContextID = 0 Then  ' works for "Stest1.chm"
                    Help.ShowHelp(Me, ProgramPath & "\Stest1.chm", HelpNavigator.TableOfContents)
                Else
                    Help.ShowHelp(Me, ProgramPath & "\Stest1.chm", HelpNavigator.TopicId, CStr(HelpContextID))
                End If
                KeyCode = 0
            End If
    ...
    Private Sub frmSTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        x = InStr(sATS_INI, "ATS.ini")
        If x > 1 Then  ' C:\Users\Public\Documents\ATS\LARRS
            sLarrs_path = Strings.Left(sATS_INI, x - 1) & "\LARRS\"
        Else
            sLarrs_path = "C:\Users\Public\Documents\ATS\LARRS\"
        End If
        ...
        'TIR 3.0.0.0007-030
        'This is the original.  Not sure why we had a date hardcoded.  removing it 
        'STversion = GatherIniFileInformation("System Startup", "SWR", "Unknown") & " Jan 17, 2016"
        ...
        ' bb removed 2016-10-20 Text = "ATS System Self Test Version " & STversion
        Me.Text = "ATS-Viper/T System Self Test"
        ...
        EoOptionInstalled = CheckOptionInstalled("EO")

        ''iNumOfTests = LAST_CORE_INST + 1
        ''If RFOptionInstalled Then ' (add 3 RF instruments)
        ''    iNumOfTests += 3
        ''End If
        ''If EoOptionInstalled Then ' (add 2 VCC and VEO2)
        ''    iNumOfTests += 2
        ''End If
        iNumOfTests = 25 'bb 2017
        With Me
            'bb 2016-11-28
            ...
            If RFOptionInstalled And EoOptionInstalled Then
                'finish right column
                'ADD two on left(11,12 at 11,12), then 13 on right (13-25 at 0-12)
                'ARB
            ...
            ElseIf RFOptionInstalled Or EoOptionInstalled Then
                'Add one on left(11 at 11), then 9 on right (12-20 at 0-8)
                'finish left column
                'ARB
                .PassFrame_11.Left = iLeft(1)
                .sscTest_11.Left = iLeft(2)
                ...
                .PassFrame_12.Top = iTop(0)
                .sscTest_12.Top = iTop(0)
                .InstrumentLabel_12.Top = iTop(0)
                'PPU
                .PassFrame_13.Left = iLeft(4)
                .sscTest_13.Left = iLeft(5)
                .InstrumentLabel_13.Left = iLeft(6)
                .PassFrame_13.Top = iTop(1)
                .sscTest_13.Top = iTop(1)
                .InstrumentLabel_13.Top = iTop(1)
                'S/R
                .PassFrame_14.Left = iLeft(4)
                .sscTest_14.Left = iLeft(5)
                .InstrumentLabel_14.Left = iLeft(6)
                .PassFrame_14.Top = iTop(2)
                .sscTest_14.Top = iTop(2)
                .InstrumentLabel_14.Top = iTop(2)
                'Serial
                .PassFrame_15.Left = iLeft(4)
                .sscTest_15.Left = iLeft(5)
                .InstrumentLabel_15.Left = iLeft(6)
                .PassFrame_15.Top = iTop(3)
                .sscTest_15.Top = iTop(3)
                .InstrumentLabel_15.Top = iTop(3)
                'COM1
                .PassFrame_16.Left = iLeft(4)
                .sscTest_16.Left = iLeft(5)
                .InstrumentLabel_16.Left = iLeft(6)
                .PassFrame_16.Top = iTop(4)
                .sscTest_16.Top = iTop(4)
                .InstrumentLabel_16.Top = iTop(4)
                'COM2
                .PassFrame_17.Left = iLeft(4)
                .sscTest_17.Left = iLeft(5)
                .InstrumentLabel_17.Left = iLeft(6)
                .PassFrame_17.Top = iTop(5)
                .sscTest_17.Top = iTop(5)
                .InstrumentLabel_17.Top = iTop(5)
                'Gigabit
                .PassFrame_18.Left = iLeft(4)
                .sscTest_18.Left = iLeft(5)
                .InstrumentLabel_18.Left = iLeft(6)
                .PassFrame_18.Top = iTop(6)
                .sscTest_18.Top = iTop(6)
                .InstrumentLabel_18.Top = iTop(6)
                'CAN
                .PassFrame_19.Left = iLeft(4)
                .sscTest_19.Left = iLeft(5)
                .InstrumentLabel_19.Left = iLeft(6)
                .PassFrame_19.Top = iTop(7)
                .sscTest_19.Top = iTop(7)
                .InstrumentLabel_19.Top = iTop(7)
                'Aprobe
                .PassFrame_20.Left = iLeft(4)
                .sscTest_20.Left = iLeft(5)
                .InstrumentLabel_20.Left = iLeft(6)
                .PassFrame_20.Top = iTop(8)
                .sscTest_20.Top = iTop(8)
                .InstrumentLabel_20.Top = iTop(8)

                If RFOptionInstalled Then
                    ' RF only, ie add 3 on right(21-23 at 9-11), then hide test 24,25
                    'RFPWR, RFSTIM and RFMEAS
                    'RFPWR
                    .PassFrame_21.Left = iLeft(4)
                    .sscTest_21.Left = iLeft(5)
                    .InstrumentLabel_21.Left = iLeft(6)
                    .PassFrame_21.Top = iTop(9)
                    .sscTest_21.Top = iTop(9)
                    .InstrumentLabel_21.Top = iTop(9)
                    'RFSTIM
                    .PassFrame_22.Left = iLeft(4)
                    .sscTest_22.Left = iLeft(5)
                    .InstrumentLabel_22.Left = iLeft(6)
                    .PassFrame_22.Top = iTop(10)
                    .sscTest_22.Top = iTop(10)
                    .InstrumentLabel_22.Top = iTop(10)
                    'RFMEAS
                    .PassFrame_23.Left = iLeft(4)
                    .sscTest_23.Left = iLeft(5)
                    .InstrumentLabel_23.Left = iLeft(6)
                    .PassFrame_23.Top = iTop(11)
                    .sscTest_23.Top = iTop(11)
                    .InstrumentLabel_23.Top = iTop(11)
                ...
                Else
                    'only VEO2, add 2 on right(24-25 at 9-10), hide test 21-23
                    'Hide RFPWR,RFSTIM,RFMEAS
                    ...
                    .sscTest_24.Left = iLeft(5)
                    .InstrumentLabel_24.Left = iLeft(6)
                    .PassFrame_24.Top = iTop(9)
                    .sscTest_24.Top = iTop(9)
                    .InstrumentLabel_24.Top = iTop(9)
                    'Add VEO2
                    .PassFrame_25.Left = iLeft(4)
                    .sscTest_25.Left = iLeft(5)
                    .InstrumentLabel_25.Left = iLeft(6)
                    .PassFrame_25.Top = iTop(10)
                    .sscTest_25.Top = iTop(10)
                    .InstrumentLabel_25.Top = iTop(10)
                End If

            Else
                'start 2nd column
                ' no VEO2 or RF, ie add 10 on right(11-20 at 0-9), then hide test 21-25(RF and VEO)
                'ARB
        ...
        Try
            ...
            If RFOptionInstalled = True Then
                ...
                XmlBuf = "<AtXmlTestRequirements> " & "<ResourceRequirement> " & _
                    "   <ResourceType>Source</ResourceType> " & "   <SignalResourceName>RFPM_1</SignalResourceName> " & _
                ...
                If status <> 0 Then
                    ...
                    LiveMode(RFMEAS) = False
                Else
                    LiveMode(RFMEAS) = True
                End If
            End If
        ...
        Else
            If EoOptionInstalled = True Then
                ' Operator Warning message
                S = "********************************" & vbCrLf
                S &= "**********  ATTENTION:  **********" & vbCrLf
                S &= "********************************" & vbCrLf
                S &= "Please ensure that the VEO2" & vbCrLf
                S &= "power cable is NOT CONNECTED to" & vbCrLf
                S &= "the ATS EO PWR-J7 connector " & vbCrLf
                S &= "except during the VEO2 selftests. " & vbCrLf & vbCrLf

                S &= "********************************" & vbCrLf
                S &= "***********  WARNING:  **********" & vbCrLf
                S &= "********************************" & vbCrLf
                S &= "Failure to remove the VEO2 Power cable" & vbCrLf
                S &= "could result in significant damage to" & vbCrLf
                S &= "the VEO2 test system!"
                MsgBox(S, MsgBoxStyle.OkOnly & MsgBoxStyle.Critical, "WARNING")
            End If
...
bypassCicl:
            ...
            If AbortTest = False Then
                ...
                For i = 1 To 30
                    ...
                    If frmAbout.Visible = False Then Exit For
                Next
            End If
            frmAbout.Close()
            frmAbout.Dispose()
        ...
        For iTest = 1 To iNumOfTests
            ...
            Select Case InstrumentToInit
                ...
                Case RFPM
                    InstrumentInitialized(RFPM) = True
                Case RFSYN
                    If RFOptionInstalled Then InitMessageBasedInstrument(InstrumentToInit)
                Case RFMEAS
                    InstrumentInitialized(RFMEAS) = True
                    '  If RFOptionInstalled Then InitMessageBasedInstrument(InstrumentToInit)
                Case EO_VCC
    ...
    Private Sub InstrumentLabel_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles InstrumentLabel_0.MouseDown, _
        ...
        Select Case senderlabel.Name
            ...
            Case "InstrumentLabel_22" : iLabel = 22 'RFSTIM
            Case "InstrumentLabel_23" : iLabel = 23 'RFMEAS
            Case "InstrumentLabel_24" : iLabel = 24 'VCC
            Case "InstrumentLabel_25" : iLabel = 25 'VEO2
        End Select
    ...
    Private Sub sscTest_Click(sender As Object, e As EventArgs) Handles sscTest_0.Click, _
        ...
        If MouseButtonX = 1 Then
            Select Case senderButton.Name
                ...
                Case "sscTest_22" : HelpContextID = 1320 : TestIndex = 22 'RFSTIM
                Case "sscTest_23" : HelpContextID = 1330 : TestIndex = 23 'RFMEAS
                Case "sscTest_24" : HelpContextID = 1360 : TestIndex = 24 'VCC
                Case "sscTest_25" : HelpContextID = 1370 : TestIndex = 25 'VEO2
            End Select
    ...
    Private Sub sscTest_0_MouseDown(sender As Object, e As MouseEventArgs) Handles sscTest_0.MouseDown, _
        ...
        Select Case ButtonX.Name
            ...
            Case "sscTest_22" : TestIndex = 22 'RFSTIM
            Case "sscTest_23" : TestIndex = 23 'RFMEAS
            Case "sscTest_24" : TestIndex = 24 'VCC
            Case "sscTest_25" : TestIndex = 25 'VEO2
        End Select
        ...
        If MouseButtonX = 2 Then ' If Right button then show instrument dependency list
            ...
            Select Case iTest
                ...
                Case 21, 22, 23
                    'RFPWR,RFSTIM,RFMEAS
                    Select Case iTest
                        Case 21 : HelpContextID = 1310
                            InstrumentList &= sGuiLabel(COUNTER) & vbCrLf

                        Case 22 : HelpContextID = 1320
                            InstrumentList &= sGuiLabel(RFPM) & vbCrLf
                            InstrumentList &= sGuiLabel(RFMEAS) & vbCrLf

                        Case 23 : HelpContextID = 1330
                            InstrumentList &= sGuiLabel(RFPM) & vbCrLf
    ...
    Private Sub sscTest_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles sscTest_0.MouseMove,
        ...
        Select Case ButtonX.Name
            ...
            Case "sscTest_22" : InstIndex = 22 'RFSTIM
            Case "sscTest_23" : InstIndex = 23 'RFMEAS
            Case "sscTest_24" : InstIndex = 24 'VCC
            Case "sscTest_25" : InstIndex = 25 'VEO2
        End Select
    ...
    Private Sub cmdHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdHelp.Click
        ...
        '' Can be used for old style helpfile if that is all that is available
        ...
        If Dir(ProgramPath & "Stest1.chm", 17) <> "" Then
            If HelpContextID = 0 Then
                Help.ShowHelp(Me, ProgramPath & "\Stest1.chm", HelpNavigator.TableOfContents)
            Else
                ' Help.ShowHelp(Me, ProgramPath & "\Stest1.chm", HelpNavigator.TopicId, "1100")
                Help.ShowHelp(Me, ProgramPath & "\Stest1.chm", HelpNavigator.TopicId, CStr(HelpContextID))
            End If
        End If
