...
Public Module modDigital
    ...
    Function TestDTS() As Integer
        ...
        ' '' For Debug only
        ''x = MsgBox("Do you want to skip the DTS probe tests?", vbYesNo)
        ''If x = vbYes Then
        ''    GoTo DTS_2_1
        ''End If

      '  If StartDTSTest = True Then GoTo RemoveSAIF

        If RunningEndToEnd = False And FirstPass = True Then
Step1:
            S = "Install adapter SP1-P1 onto the SAIF J1 connector. "
...
RetryW15:
        ...
        If dMeasurement < 2 Or dMeasurement > 6 Then
            ...
            If x <> vbYes Then
                ...
                DisplaySetup(S, "ST-DTS-W15-01.jpg", 1)
                If AbortTest = True Then GoTo TestComplete
                GoTo RetryW15
            End If
        End If
        ...
        If dMeasurement < 2 Or dMeasurement > 6 Then
            ...
            If OptionFaultMode = SOFmode Then
                ...
                DisplaySetup(S, "ST-DTS-W15-2.jpg", 1)
                If AbortTest = True Then GoTo TestComplete
        ...
        For PinCount = 0 To 63
            If CCCPinResult(PinCount) = TERM9_RESULT_FAIL Then
                ...
                Select Case PinCount
                    ...
                    Case 40 : Echo("  P7-56(Ch40) to A1J71-48 (via W71) to A1J71-47 to P7-24(GCh40)")
                    Case 41 : Echo("  P7-55(Ch41) to A1J71-46 (via W71) to A1J71-45 to P7-23(GCh41)")
                    Case 42 : Echo("  P7-54(Ch42) to A1J71-44 (via W71) to A1J71-43 to P7-22(GCh42)")
                    Case 43 : Echo("  P7-53(Ch43) to A1J71-42 (via W71) to A1J71-41 to P7-21(GCh43)")
                    Case 44 : Echo("  P7-52(Ch44) to A1J71-40 (via W71) to A1J71-39 to P7-20(GCh44)")
                    Case 45 : Echo("  P7-51(Ch45) to A1J71-38 (via W71) to A1J71-37 to P7-19(GCh45)")
                    Case 46 : Echo("  P7-50(Ch46) to A1J71-36 (via W71) to A1J71-35 to P7-18(GCh46)")
                    Case 47 : Echo("  P7-49(Ch47) to A1J71-34 (via W71) to A1J71-33 to P7-17(GCh47)")
                    Case 48 : Echo("  P7-48(Ch48) to A1J71-32 (via W71) to SAIF J1-A11 to J1-B11 (via SP1) to A1J71-31 to P7-16(GCh48 via W71)")
                    Case 49 : Echo("  P7-47(Ch49) to A1J71-30 (via W71) to SAIF J1-C11 to J1-D11 (via SP1) to A1J71-29 to P7-15(GCh49 via W71)")
                    Case 50 : Echo("  P7-46(Ch50) to A1J71-28 (via W71) to SAIF J1-E11 to J1-F11 (via SP1) to A1J71-27 to P7-14(GCh50 via W71)")
                    Case 51 : Echo("  P7-45(Ch51) to A1J71-26 (via W71) to SAIF J1-G11 to J1-H11 (via SP1) to A1J71-25 to P7-13(GCh51 via W71)")
                    Case 52 : Echo("  P7-44(Ch52) to A1J71-24 (via W71) to SAIF J1-J11 to J1-K11 (via SP1) to A1J71-23 to P7-12(GCh52 via W71)")
                    Case 53 : Echo("  P7-43(Ch53) to A1J71-22 (via W71) to SAIF J1-A10 to J1-B10 (via SP1) to A1J71-21 to P7-11(GCh53 via W71)")
                    Case 54 : Echo("  P7-42(Ch54) to A1J71-20 (via W71) to SAIF J1-C10 to J1-D10 (via SP1) to A1J71-19 to P7-10(GCh54 via W71)")
                    Case 55 : Echo("  P7-41(Ch55) to A1J71-18 (via W71) to SAIF J1-E10 to J1-F10 (via SP1) to A1J71-17 to P7-09(GCh55 via W71)")
                    Case 56 : Echo("  P7-40(Ch56) to A1J71-16 (via W71) to SAIF J1-G10 to J1-H10 (via SP1) to A1J71-15 to P7-08(GCh56 via W71)")
                    Case 57 : Echo("  P7-39(Ch57) to A1J71-14 (via W71) to SAIF J1-J10 to J1-K10 (via SP1) to A1J71-13 to P7-07(GCh57 via W71)")
                    Case 58 : Echo("  P7-38(Ch58) to A1J71-12 (via W71) to SAIF J1-A09 to J1-B09 (via SP1) to A1J71-11 to P7-06(GCh58 via W71)")
                    Case 59 : Echo("  P7-37(Ch59) to A1J71-10 (via W71) to SAIF J1-C09 to J1-D09 (via SP1) to A1J71-09 to P7-05(GCh59 via W71)")
                    Case 60 : Echo("  P7-36(Ch60) to A1J71-08 (via W71) to SAIF J1-E09 to J1-F09 (via SP1) to A1J71-07 to P7-04(GCh60 via W71)")
                    Case 61 : Echo("  P7-35(Ch61) to A1J71-06 (via W71) to SAIF J1-G09 to J1-H09 (via SP1) to A1J71-05 to P7-03(GCh61 via W71)")
                    Case 62 : Echo("  P7-34(Ch62) to A1J71-04 (via W71) to SAIF J1-J09 to J1-K09 (via SP1) to A1J71-03 to P7-02(GCh62 via W71)")
                    Case 63 : Echo("  P7-33(Ch63) to A1J71-02 (via W71) to SAIF J1-A08 to J1-B08 (via SP1) to A1J71-01 to P7-01(GCh63 via W71)")
                End Select
            End If
        Next PinCount
        ...
        For PinCount = 0 To 63
            If CCCPinResult(PinCount) = TERM9_RESULT_FAIL Then
                ...
                Select Case PinCount
                    ...
                    Case 40 : Echo("  P5-56(Ch104) to A1J51-48 (via W51) to A1J51-47 to P5-24(GCh104)")
                    Case 41 : Echo("  P5-55(Ch105) to A1J51-46 (via W51) to A1J51-45 to P5-23(GCh105)")
                    Case 42 : Echo("  P5-54(Ch106) to A1J51-44 (via W51) to A1J51-43 to P5-22(GCh106)")
                    Case 43 : Echo("  P5-53(Ch107) to A1J51-42 (via W51) to A1J51-41 to P5-21(GCh107)")
                    Case 44 : Echo("  P5-52(Ch108) to A1J51-40 (via W51) to A1J51-39 to P5-20(GCh108)")
                    Case 45 : Echo("  P5-51(Ch109) to A1J51-38 (via W51) to A1J51-37 to P5-19(GCh109)")
                    Case 46 : Echo("  P5-50(Ch110) to A1J51-36 (via W51) to A1J51-35 to P5-18(GCh110)")
                    Case 47 : Echo("  P5-49(Ch111) to A1J51-34 (via W51) to A1J51-33 to P5-17(GCh111)")
                    Case 48 : Echo("  P5-48(Ch112) to A1J51-32 (via W51) to SAIF J1-C08 to J1-D08 (via SP1) to A1J51-31 to P5-16(GCh112 via W51)")
                    Case 49 : Echo("  P5-47(Ch113) to A1J51-30 (via W51) to SAIF J1-E08 to J1-F08 (via SP1) to A1J51-29 to P5-15(GCh113 via W51)")
                    Case 50 : Echo("  P5-46(Ch114) to A1J51-28 (via W51) to SAIF J1-G08 to J1-H08 (via SP1) to A1J51-27 to P5-14(GCh114 via W51)")
                    Case 51 : Echo("  P5-45(Ch115) to A1J51-26 (via W51) to SAIF J1-J08 to J1-K08 (via SP1) to A1J51-25 to P5-13(GCh115 via W51)")
                    Case 52 : Echo("  P5-44(Ch116) to A1J51-24 (via W51) to SAIF J1-A07 to J1-B07 (via SP1) to A1J51-23 to P5-12(GCh116 via W51)")
                    Case 53 : Echo("  P5-43(Ch117) to A1J51-22 (via W51) to SAIF J1-C07 to J1-D07 (via SP1) to A1J51-21 to P5-11(GCh117 via W51)")
                    Case 54 : Echo("  P5-42(Ch118) to A1J51-20 (via W51) to SAIF J1-E07 to J1-F07 (via SP1) to A1J51-19 to P5-10(GCh118 via W51)")
                    Case 55 : Echo("  P5-41(Ch119) to A1J51-18 (via W51) to SAIF J1-G07 to J1-H07 (via SP1) to A1J51-17 to P5-09(GCh119 via W51)")
                    Case 56 : Echo("  P5-40(Ch120) to A1J51-16 (via W51) to SAIF J1-J07 to J1-K07 (via SP1) to A1J51-15 to P5-08(GCh120 via W51)")
                    Case 57 : Echo("  P5-39(Ch121) to A1J51-14 (via W51) to SAIF J1-A06 to J1-B06 (via SP1) to A1J51-13 to P5-07(GCh121 via W51)")
                    Case 58 : Echo("  P5-38(Ch122) to A1J51-12 (via W51) to SAIF J1-C06 to J1-D06 (via SP1) to A1J51-11 to P5-06(GCh122 via W51)")
                    Case 59 : Echo("  P5-37(Ch123) to A1J51-10 (via W51) to SAIF J1-E06 to J1-F06 (via SP1) to A1J51-09 to P5-05(GCh123 via W51)")
                    Case 60 : Echo("  P5-36(Ch124) to A1J51-08 (via W51) to SAIF J1-G06 to J1-H06 (via SP1) to A1J51-07 to P5-04(GCh124 via W51)")
                    Case 61 : Echo("  P5-35(Ch125) to A1J51-06 (via W51) to SAIF J1-J06 to J1-K06 (via SP1) to A1J51-05 to P5-03(GCh125 via W51)")
                    Case 62 : Echo("  P5-34(Ch126) to A1J51-04 (via W51) to SAIF J1-A05 to J1-B05 (via SP1) to A1J51-03 to P5-02(GCh126 via W51)")
                    Case 63 : Echo("  P5-33(Ch127) to A1J51-02 (via W51) to SAIF J1-C05 to J1-D05 (via SP1) to A1J51-01 to P5-01(GCh127 via W51)")
                End Select
            End If
            Application.DoEvents()
            If AbortTest = True Then GoTo TestComplete
        ...
        For PinCount = 0 To 63
            If CCCPinResult(PinCount) = TERM9_RESULT_FAIL Then
                ...
                Select Case PinCount
                    ...
                    Case 40 : Echo("  P3-56(Ch168) to A1J31-48 (via W31) to A1J31-47 to P3-24(GCh168)")
                    Case 41 : Echo("  P3-55(Ch169) to A1J31-46 (via W31) to A1J31-45 to P3-23(GCh169)")
                    Case 42 : Echo("  P3-54(Ch170) to A1J31-44 (via W31) to A1J31-43 to P3-22(GCh170)")
                    Case 43 : Echo("  P3-53(Ch171) to A1J31-42 (via W31) to A1J31-41 to P3-21(GCh171)")
                    Case 44 : Echo("  P3-52(Ch172) to A1J31-40 (via W31) to A1J31-39 to P3-20(GCh172)")
                    Case 45 : Echo("  P3-51(Ch173) to A1J31-38 (via W31) to A1J31-37 to P3-19(GCh173)")
                    Case 46 : Echo("  P3-50(Ch174) to A1J31-36 (via W31) to A1J31-35 to P3-18(GCh174)")
                    Case 47 : Echo("  P3-49(Ch175) to A1J31-34 (via W31) to A1J31-33 to P3-17(GCh175)")
                    Case 48 : Echo("  P3-48(Ch176) to A1J31-32 (via W31) to SAIF J1-E05 to J1-F05 (via SP1) to A1J31-31 to P3-16(GCh176 via W31)")
                    Case 49 : Echo("  P3-47(Ch177) to A1J31-30 (via W31) to SAIF J1-G05 to J1-H05 (via SP1) to A1J31-29 to P3-15(GCh177 via W31)")
                    Case 50 : Echo("  P3-46(Ch178) to A1J31-28 (via W31) to SAIF J1-J05 to J1-K05 (via SP1) to A1J31-27 to P3-14(GCh178 via W31)")
                    Case 51 : Echo("  P3-45(Ch179) to A1J31-26 (via W31) to SAIF J1-A04 to J1-B04 (via SP1) to A1J31-25 to P3-13(GCh179 via W31)")
                    Case 52 : Echo("  P3-44(Ch180) to A1J31-24 (via W31) to SAIF J1-C04 to J1-D04 (via SP1) to A1J31-23 to P3-12(GCh180 via W31)")
                    Case 53 : Echo("  P3-43(Ch181) to A1J31-22 (via W31) to SAIF J1-E04 to J1-F04 (via SP1) to A1J31-21 to P3-11(GCh181 via W31)")
                    Case 54 : Echo("  P3-42(Ch182) to A1J31-20 (via W31) to SAIF J1-G04 to J1-H04 (via SP1) to A1J31-19 to P3-10(GCh182 via W31)")
                    Case 55 : Echo("  P3-41(Ch183) to A1J31-18 (via W31) to SAIF J1-J04 to J1-K04 (via SP1) to A1J31-17 to P3-09(GCh183 via W31)")
                    Case 56 : Echo("  P3-40(Ch184) to A1J31-16 (via W31) to SAIF J1-A03 to J1-B03 (via SP1) to A1J31-15 to P3-08(GCh184 via W31)")
                    Case 57 : Echo("  P3-39(Ch185) to A1J31-14 (via W31) to SAIF J1-C03 to J1-D03 (via SP1) to A1J31-13 to P3-07(GCh185 via W31)")
                    Case 58 : Echo("  P3-38(Ch186) to A1J31-12 (via W31) to SAIF J1-E03 to J1-F03 (via SP1) to A1J31-11 to P3-06(GCh186 via W31)")
                    Case 59 : Echo("  P3-37(Ch187) to A1J31-10 (via W31) to SAIF J1-G03 to J1-H03 (via SP1) to A1J31-09 to P3-05(GCh187 via W31)")
                    Case 60 : Echo("  P3-36(Ch188) to A1J31-08 (via W31) to SAIF J1-J03 to J1-K03 (via SP1) to A1J31-07 to P3-04(GCh188 via W31)")
                    Case 61 : Echo("  P3-35(Ch189) to A1J31-06 (via W31) to SAIF J1-A02 to J1-B02 (via SP1) to A1J31-05 to P3-03(GCh189 via W31)")
                    Case 62 : Echo("  P3-34(Ch190) to A1J31-04 (via W31) to SAIF J1-C02 to J1-D02 (via SP1) to A1J31-03 to P3-02(GCh190 via W31)")
                    Case 63 : Echo("  P3-33(Ch191) to A1J31-02 (via W31) to SAIF J1-E02 to J1-F02 (via SP1) to A1J31-01 to P3-01(GCh191 via W31)")
                End Select
            End If
        Next PinCount
...
RemoveSAIF:  ' remove the saif even if receiver switch says it was already removed
        ...
        DisplaySetup(S, "ST-DTS-SAIF-OFF-1.jpg", 1)
        If AbortTest = True Then GoTo TestComplete
...
DTS_17_1:  ' DTS-17-001  Initialize DTS
        ...
        InitStatus = terM9_init("TERM9::#0", VI_TRUE, VI_TRUE, hndlDTI) 'gets new handle
        If InitStatus > &H4FFF0000 Then
            MessageBox.Show("In If InitStatus > &H4FFF0000 Then", "Self Test", MessageBoxButtons.OK)
...
InstallSaif2:
        ...
        If SAIFinstalled = False Then
            ...
            DisplaySetup(S, "ST-DTS-SAIF-ON-1.jpg", 2)
