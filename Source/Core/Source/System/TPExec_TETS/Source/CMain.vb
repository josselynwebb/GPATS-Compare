...
<System.Runtime.InteropServices.ProgId("cMain_NET.cMain")> Public Class cMain
    ...
    Public Function nSetModuleList(ByRef sModuleNames() As String, ByRef nModuleRunTime() As Integer) As Integer
        MaxModules = sModuleNames.Length
        ...
        With TestData
            If bStatus Then
                ...
                If bStatus Then
                    ...
                    If Not bSimulation Then i = FHDB.SaveData(.sStart, .SStop, .EROs, .sTPCCN, .sUUTSerial, .sUUTRev, .sIDSerial, .nStatus,
    ...
    Public Sub ModulePassed(ByRef sModule As String)
        ...
        If Not bSimulation And Not bEndToEnd Then
            With TestData
                ...
                .sComment = "No operator comments"
                .nStatus = True
                i = FHDB.SaveData(.sStart, .SStop, .EROs, .sTPCCN, .sUUTSerial, .sUUTRev, .sIDSerial, .nStatus,
                                  .sFailStep, .sCallout, .dMeasurement, .sUOM, .duLimit, .dlLimit, .sComment)
            End With
        End If
    End Sub
    ...
    Public Sub DisplayProbeMessage(ByRef sLocation As String, ByRef sProbeInstructions() As String, Optional ByRef bContinueOnly As Boolean = False)
        ...
        gFrmMain.Message.SetBounds(gFrmMain.pinp.Left + Val(sProbe(4)), gFrmMain.pinp.Top + Val(sProbe(5)), 0, 0,
