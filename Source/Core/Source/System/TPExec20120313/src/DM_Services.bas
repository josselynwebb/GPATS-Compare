...
Declare Function DM_getVersion Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal version As String) As Long

Declare Function DM_diagnoseTest Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal testName As String, ByVal assemblyName As String, ByVal unitID As String, ByVal vi As Long) As Long

Declare Function DM_diagnosticCompleted Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal diagnostic As Long, ByVal Status As Long, ByRef diagnosisHandle As Long) As Long

Declare Function DM_setDiagnosticEnable Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal diagnostic As Long, ByVal enable As Long) As Long

Declare Function DM_getDiagnosticEnable Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal diagnostic As Long, ByRef enable As Long) As Long

Declare Function DM_getDiagnosticAvailable Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal testName As String, ByVal diagnostic As Long, ByRef available As Long) As Long
...
Declare Function DM_errorMessage Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal Status As Long, ByVal maxSize As Integer, ByVal severity As String, ByVal buffer As String) As Long


Declare Function DM_setDiagnosticOutputFile Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal fileName As String) As Long
'
...
Declare Function DM_getDiagnosticOutputFile Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByRef fileName As String) As Long
'
...
Declare Function DM_getDiagnosisText Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal diagnostic As Long, ByVal diagnosisMaxSize As Long, ByRef diagnosis As String) As Long
'
...
Declare Function DM_getFaultInfo Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal testName As String, ByVal diagnostic As Long, ByVal maxMsgSize As Long, ByRef faultStr As String, ByRef msgStr As String, ByVal prevFault As Long, ByRef nextFault As Long) As Long
...
Declare Function DM_setScreenDiagEnable Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal value As Long) As Long
...
Declare Function DM_getScreenDiagEnable Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByRef value_ptr As Long) As Long
...
Declare Function DM_setDiagnosticOutputDir Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByVal dirName As String) As Long
...
Declare Function DM_getDiagnosticOutputDir Lib "C:\Program Files\Teradyne\Diagnostics\bin\DiagMgr.dll" (ByRef dirName_ptr As String) As Long
