...
Module MAINMod
    ...
    Public gRFMa As New RFMSLib.RFMa_if ' for RF measurement analyzer
    Public gRFCt As New RFMSLib.RFCt_if ' for RF counter
    Public gRFPM As New RFMSLib.RFPm_if ' for RF power meter
