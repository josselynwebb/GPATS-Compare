Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("S803_NET.S803")> Public Class S803
	'**************************************************************
	...
	Public Sub swClose(ByRef nPinA As Short, ByRef nPinB As Short)
		...
		'Set Display
		gFrmMain.txtInstrument.Text = "Switch S803"
		gFrmMain.txtCommand.Text = "swClose"
		
		'Error Check Pin Numbers
		If nPinA < 1 Or nPinA > 1 Then
			Echo("SWITCH S803 PROGRAMMING ERROR:  Command S803.swClose nPinA argument out of range.")
			Err.Raise(-1000)
			Exit Sub
		End If
		If nPinB < 2 Or nPinB > 9 Then
			Echo("SWITCH S803 PROGRAMMING ERROR:  Command S803.swClose nPinB argument out of range.")
			Err.Raise(-1000)
			Exit Sub
		End If
