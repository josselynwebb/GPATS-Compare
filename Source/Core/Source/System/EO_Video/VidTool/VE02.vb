...
Module VE02
    ...
    ''' 6.		Laser Align
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_SYSTEM_CONFIGURATION_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="RESET_MODULE_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="IRWIN_SHUTDOWN", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_BIT_DATA_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_BIT_DATA_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_MODULE_ID_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' 1: Correct ID detected.
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_MODULE_ID_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_STATUS_BYTE_MESSAGE_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''X = Don’t care.
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_STATUS_BYTE_MESSAGE_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_TEMP_TARGET_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="GET_TEMP_TARGET_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RDY_WINDOW_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RDY_WINDOW_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' int target position
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TARGET_POSITION_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TARGET_POSITION_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TEMP_ABSOLUTE_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TEMP_ABSOLUTE_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TEMP_DIFFERENTIAL_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TEMP_DIFFERENTIAL_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_TRIGGER_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_TRIGGER_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_DELAY_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_DELAY_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  3	Visible
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_SOURCE_STAGE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  3	Visible
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_SOURCE_STAGE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  3	Camera (Beam Splitter)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_SENSOR_STAGE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  3	Camera (Beam Splitter)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_SENSOR_STAGE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''   2	    1064 diode
    '''</param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SELECT_DIODE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''   2	    1064 diode
    '''</param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SELECT_DIODE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  4	Calibrate
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TRIGGER_SOURCE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  4	Calibrate
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_TRIGGER_SOURCE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE_AMPLITUDE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' float 50 - 125 ms
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE_PERIOD_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE_PERIOD_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' int 0 or 1
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_OPERATION_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''   1	    laser is on
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_OPERATION_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' float 500-60000 m
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RANGE_EMULATION_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RANGE_EMULATION_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE2_DELAY_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE2_DELAY_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''     1	  Second return pulse is larger
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SELECT_LARGER_PULSE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''     1	  Second return pulse is larger
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SELECT_LARGER_PULSE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE_PERCENTAGE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_PULSE_PERCENTAGE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''     1	Start laser in test configuration
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LASER_TEST_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''     1	Start laser in test configuration
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LASER_TEST_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RADIANCE_VIS_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_RADIANCE_VIS_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_AZ_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_AZ_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' int from 0 - 20000 valid (units=steps)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_EL_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' int pointer values from 0 - 20000 valid (units=steps)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_EL_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    ''' <param name="angposition">
    ''' int from 0 to 359 degrees valid 
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_POLARIZE_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    Public Sub SET_LARRS_POLARIZE_LASER_INITIATE(angposition As Integer)
    End Sub

    ''' <summary>
    ''' Get LARRS polarization angle
    ''' </summary>
    ''' <param name="angposition">
    ''' int pointer values from 0 to 359 degrees valid 
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_LARRS_POLARIZE_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    Public Sub SET_LARRS_POLARIZE_LASER_FETCH(ByRef angposition As Integer)
    End Sub
    ...
    '''     1	Turn camera power on
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_POWER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''     1	Turn camera power on
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="SET_CAMERA_POWER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' Intensity_ratio is the percent above the minimum pixel value that is a cutoff value for finding the beam. (valid 0 - 100%)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_LASER_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_LASER_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_LASER_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_TV_VIS_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_TV_VIS_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_TV_VIS_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' The Intensity_Ratio is a percentage over the minimum value that determines if a blob is to be considered the boresight signal.  (valid 0 - 100%)
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_IR_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="BORESIGHT_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''  12   RS343: 944 vl, 944 hl
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="IMAGE_UNIFORMITY_IR_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="IMAGE_UNIFORMITY_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''    9	Unknown Camera 
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="IMAGE_UNIFORMITY_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' lCorrectionCurveIndex (value 0-3) is a correction curve based on the frequency response of the optics. This must be used for high spatial frequencies. This is an Index into a predefined array of correction curves: 0=No Curve, 1=8-12um, FAR IR, 2=3-5um, MID IR, 3=Visible.
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="MODULATION_TRANSFER_FUNCTION_IR_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' /// </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="MODULATION_TRANSFER_FUNCTION_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    '''    14	Correction Curve out of range
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="MODULATION_TRANSFER_FUNCTION_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' lAmbBlockBotRightY is the Ambient Block rectangle Y coordinate of the lower right corner.
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="NOISE_EQUIVALENT_DIFFERENTIAL_TEMPERATURE_IR_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="NOISE_EQUIVALENT_DIFFERENTIAL_TEMPERATURE_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="NOISE_EQUIVALENT_DIFFERENTIAL_TEMPERATURE_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' noisecriteria is the noise threshold before a channel is failed.
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="CHANNEL_INTEGRITY_IR_SETUP", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </summary>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="CHANNEL_INTEGRITY_IR_INITIATE", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
    ...
    ''' </param>
    <DllImport("C:\IRWin2001\VEO2.dll", EntryPoint:="CHANNEL_INTEGRITY_IR_FETCH", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True)> _
