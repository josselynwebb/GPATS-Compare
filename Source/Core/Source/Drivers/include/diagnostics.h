 ...
 * Revision History:
 *
 * 00015 08/06/03 jxy added SET_OUTPUT_DIAGNOSIS/ERROR_CALLBACK
...
typedef enum DM_CALLBACK_LIST {
	...
	SET_OUTPUT_DIAGNOSIS_CALLBACK,
	SET_OUTPUT_ERROR_CALLBACK,
...
#define LAST_DM_CALLBACK   SET_OUTPUT_ERROR_CALLBACK
