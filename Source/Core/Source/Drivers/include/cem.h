...
#define  SYS12F			/* Windows NT - MS Visual C++ 6.0	*/
#define  SYSNAME        "Windows NT - MSVC 6.0"
#define  SYSCONFNAME    "Windows NT - MSVC 6.0"
#define  SYSCONFDATE    "20010609"
#define  SYSVERDATENAME "(E35)"
...
#define GetDatum(m, q)          get_datum(m, q)
				 /* Get DATUM  -  m = Modifier q = Qualifier*/
