...
/*= DEFINES =================================================================*/
#define hpe1420b_REVISION     "Rev 1.0, 2/96, CVI 3.1" /*  Instrument driver revision */
#define BUFFER_SIZE         512L                       /*  File I/O buffer size       */
#define hpe1420b_MANF_ID      0x0fff                   /*  Instrument manufacturer ID */
#define hpe1420b_MODEL_CODE   0x0243                   /*  Instrument model code      */
...
/*****************************************************************************/
/* hpe1420b_stringValPair is used in the hpe1420b_errorMessage function      */
/* hpe1420b_statusDataRanges is used to track session dependent status & ranges*/
/*===========================================================================*/
typedef struct  hpe1420b_stringValPair
{
   ViStatus stringVal;
   ViString stringName;
}  hpe1420b_tStringValPair;
...
/*===========================================================================*/
struct hpe1420b_statusDataRanges {
    ViInt16 triggerMode;
    ViInt16 val2;
    ViInt16 val3;
...
typedef struct hpe1420b_statusDataRanges *hpe1420b_instrRange;

/*****************************************************************************/
/*= UTILITY ROUTINE DECLARATIONS (Non-Exportable Functions) =================*/
/*****************************************************************************/
ViBoolean hpe1420b_invalidViBooleanRange (ViBoolean val);
ViBoolean hpe1420b_invalidViInt16Range (ViInt16 val, ViInt16 min, ViInt16 max);
ViBoolean hpe1420b_invalidViInt32Range (ViInt32 val, ViInt32 min, ViInt32 max);
ViBoolean hpe1420b_invalidViUInt16Range (ViUInt16 val, ViUInt16 min, ViUInt16 max);
ViBoolean hpe1420b_invalidViUInt32Range (ViUInt32 val, ViUInt32 min, ViUInt32 max);
ViBoolean hpe1420b_invalidViReal32Range (ViReal32 val, ViReal32 min, ViReal32 max);
ViBoolean hpe1420b_invalidViReal64Range (ViReal64 val, ViReal64 min, ViReal64 max);
ViStatus hpe1420b_initCleanUp (ViSession openRMSession, ViPSession openInstrSession, ViStatus currentStatus);
ViStatus hpe1420b_readToFile (ViSession instrSession, ViString filename, ViUInt32 readBytes, ViPUInt32 retCount);
ViStatus hpe1420b_writeFromFile (ViSession instrSession, ViString filename, ViUInt32 writeBytes, ViPUInt32 retCount);
ViStatus hpe1420b_defaultInstrSetup (ViSession openInstrSession);
...
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViSession rmSession = 0;
    ViUInt32 retCnt = 0;
    ViUInt16 manfID = 0, modelCode = 0;    

    /*- Check input parameter ranges ----------------------------------------*/
    if (hpe1420b_invalidViBooleanRange (IDQuery))
        return VI_ERROR_PARAMETER2;
    if (hpe1420b_invalidViBooleanRange (resetDev))
        return VI_ERROR_PARAMETER3;

    /*- Open instrument session ---------------------------------------------*/
    if ((hpe1420b_status = viOpenDefaultRM (&rmSession)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viOpen (rmSession, resourceName, VI_NULL, VI_NULL, instrSession)) < 0) {
        viClose (rmSession);
        return hpe1420b_status;
    }

    /*- Configure VISA Formatted I/O ----------------------------------------*/
    if ((hpe1420b_status = viSetAttribute (*instrSession, VI_ATTR_TMO_VALUE, 10000)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
    if ((hpe1420b_status = viSetBuf (*instrSession, VI_READ_BUF|VI_WRITE_BUF, 4000)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
    if ((hpe1420b_status = viSetAttribute (*instrSession, VI_ATTR_WR_BUF_OPER_MODE,
                            VI_FLUSH_ON_ACCESS)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
    if ((hpe1420b_status = viSetAttribute (*instrSession, VI_ATTR_RD_BUF_OPER_MODE,
                            VI_FLUSH_ON_ACCESS)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);

    /*- Identification Query ------------------------------------------------*/
    if (IDQuery) {
        if ((hpe1420b_status = viGetAttribute (*instrSession, VI_ATTR_MANF_ID, &manfID)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
        if ((hpe1420b_status = viGetAttribute (*instrSession, VI_ATTR_MODEL_CODE, &modelCode)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
        
        if (manfID != hpe1420b_MANF_ID && modelCode != hpe1420b_MODEL_CODE)
            return hpe1420b_initCleanUp (rmSession, instrSession, VI_ERROR_FAIL_ID_QUERY);
    }

    /*- Reset instrument ----------------------------------------------------*/
    if (resetDev) {
        if ((hpe1420b_status = hpe1420b_reset (*instrSession)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
    }       
    else  /*- Send Default Instrument Setup ---------------------------------*/
        if ((hpe1420b_status = hpe1420b_defaultInstrSetup (*instrSession)) < 0)
            return hpe1420b_initCleanUp (rmSession, instrSession, hpe1420b_status);
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confAcCurr (ViSession instrSession, 
                        ViInt16 range, ViReal64 res, ViInt16 filter)
{
    ...
    if (hpe1420b_invalidViInt16Range (range, 0, 2))
        return VI_ERROR_PARAMETER2;
    if (range)    
      if (hpe1420b_invalidViReal64Range (res, acRes[0][range-1],acRes[1][range-1]))
          return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViInt16Range (filter, 0, 2))      
    ...
    if ((hpe1420b_status = viWrite(instrSession, wrtBuf, NumFmtdBytes(), &retCnt)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confDcCurr (ViSession instrSession, 
                        ViInt16 range, ViInt16 time, ViReal64 res, ViInt16 zero)
{
    ...
    if (hpe1420b_invalidViInt16Range (range, 0, 4))
        return VI_ERROR_PARAMETER2;
    if (hpe1420b_invalidViInt16Range (time, 0, 4))      
        return VI_ERROR_PARAMETER3;
    if (range)
      if (hpe1420b_invalidViReal64Range (res, 1E-9, 1.0))
          return VI_ERROR_PARAMETER4;
    if (hpe1420b_invalidViInt16Range (zero, 0, 2))      
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confAcVolt (ViSession instrSession,
                        ViInt16 range, ViInt16 filter, ViReal64 res)
{
    ...
    if (hpe1420b_invalidViInt16Range (range, 0, 5))
        return VI_ERROR_PARAMETER2;
    if (range)
      if (hpe1420b_invalidViReal64Range (res, acVRes[0][range-1], acVRes[1][range-1]))
          return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViInt16Range (filter, 0, 2))      
        return VI_ERROR_PARAMETER4;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confDcVolt (ViSession instrSession,
                        ...
                        ViReal64 res, ViBoolean type, ViBoolean inpZ)
{
    ...
    if (hpe1420b_invalidViInt16Range (time, 0, 4))      
        return VI_ERROR_PARAMETER4;
    if (hpe1420b_invalidViReal64Range (res, -1.0, 100.0))
        return VI_ERROR_PARAMETER5;
    if (hpe1420b_invalidViBooleanRange (type))
        return VI_ERROR_PARAMETER6;
    if (hpe1420b_invalidViBooleanRange (inpZ))
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confFreqPer (ViSession instrSession, 
                        ViInt16 range, ViInt16 time, ViBoolean freqMode)
{
    ...
    if (hpe1420b_invalidViInt16Range (range, 0, 4))
        return VI_ERROR_PARAMETER2;
    if (hpe1420b_invalidViInt16Range (time, 0, 2))      
        return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViBooleanRange (freqMode))
        return VI_ERROR_PARAMETER4;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confResist (ViSession instrSession, 
                        ...
                        ViInt16 zero, ViBoolean type)
{
    ...
    if (hpe1420b_invalidViInt16Range (range, 0, 7))
        return VI_ERROR_PARAMETER2;
    if (hpe1420b_invalidViInt16Range (time, 0, 4))      
        return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViReal64Range (res, -1.0, 1E6))
        return VI_ERROR_PARAMETER4;
    if (hpe1420b_invalidViInt16Range (zero, 0, 2))      
        return VI_ERROR_PARAMETER5;
    if (hpe1420b_invalidViBooleanRange (type))
...
/*           instrument.                                                     */
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confTrigger (ViSession instrSession,
                        ...
                        ViBoolean delayMode, ViInt32 sample, ViInt32 cnt)
{
    ...
    if (hpe1420b_invalidViInt16Range (triggerMode, 0, 10))
        return VI_ERROR_PARAMETER2;
    if (hpe1420b_invalidViReal64Range (triggerDelays, 0.0, 3600.0))
        return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViBooleanRange (delayMode))
        return VI_ERROR_PARAMETER4;
    if (hpe1420b_invalidViInt32Range (sample, 1, 50000))
        return VI_ERROR_PARAMETER5;
    if (hpe1420b_invalidViInt32Range (cnt, 1, 50000))
        return VI_ERROR_PARAMETER6;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confMath (ViSession instrSession, 
                        ...
                        ViReal64 llimit, ViReal64 ulimit)
{
    ...
    if (hpe1420b_invalidViInt16Range (oper, 0, 5))
        return VI_ERROR_PARAMETER2;
    if (oper == 2) 
        if (hpe1420b_invalidViReal64Range (offset, -120.0, 120.0))
            return VI_ERROR_PARAMETER3;
    if (oper == 3)
        if (hpe1420b_invalidViReal64Range (offset, -200.0, 200.0))
            return VI_ERROR_PARAMETER3;
    if (hpe1420b_invalidViInt32Range (dBm, 0, 16))
        return VI_ERROR_PARAMETER4;
    if (hpe1420b_invalidViReal64Range (llimit, -120.0, 120.0))
        return VI_ERROR_PARAMETER5;
    if (hpe1420b_invalidViReal64Range (ulimit, -120.0, 120.0))
        return VI_ERROR_PARAMETER6;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_confOut (ViSession instrSession, ViInt16 line)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViChar   wrtBuf[BUFFER_SIZE];
    ViUInt32 retCnt;
    
    if (hpe1420b_invalidViInt16Range (line, 0, 8))
        return VI_ERROR_PARAMETER2;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_trigger (ViSession instrSession)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViChar   wrtBuf[BUFFER_SIZE];
    ViUInt32 retCnt;

    if ((hpe1420b_status = viWrite(instrSession, "*TRG;", 5, &retCnt)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_initiate (ViSession instrSession)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViChar   wrtBuf[BUFFER_SIZE];
    ViUInt32 retCnt;

    if ((hpe1420b_status = viWrite(instrSession, "INIT", 4, &retCnt)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_abort (ViSession instrSession)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViChar   wrtBuf[BUFFER_SIZE];
    ViUInt32 retCnt;

    if ((hpe1420b_status = viWrite(instrSession, "ABOR", 4, &retCnt)) < 0)
        return hpe1420b_status;
...
/* Purpose:  This function immediately triggers the instrument.              */
/*===========================================================================*/ 
ViStatus _VI_FUNC hpe1420b_readMeas (ViSession instrSession,       
                        ViPReal64 values)                 
{                                                                   
    ViStatus hpe1420b_status = VI_SUCCESS;                          
    ...
    if ((hpe1420b_status = viWrite (instrSession, "*SRE 16;FETC?", 13, &retCnt)) < 0)           
        return hpe1420b_status;
    if ((hpe1420b_status = hpe1420b_waitForRqs (instrSession, 30000, statusByte)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viWrite (instrSession, "*SRE 0", 6, &retCnt)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_readMinMax (ViSession instrSession,
                        ...
                        ViPReal64 cnt)
{
    ...
    if ((hpe1420b_status = viWrite (instrSession, ":CALC:AVER:MIN?;", 16, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
    ...
    if ((hpe1420b_status = viWrite (instrSession, ":CALC:AVER:MAX?;", 16, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
    ...
    if ((hpe1420b_status = viWrite (instrSession, ":CALC:AVER:AVER?;", 17, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
    ...
    if ((hpe1420b_status = viWrite (instrSession, ":CALC:AVER:COUN?;", 17, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
    if (Scan (rdBuf, "%s>%f", avg) != 1)
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_querDataPts (ViSession instrSession, ViInt16 *num)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViChar   wrtBuf[BUFFER_SIZE], rdBuf[BUFFER_SIZE];
    ViUInt32 retCnt;

    if ((hpe1420b_status = viWrite (instrSession, "DATA:POIN?", 10, &retCnt)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viRead (instrSession, rdBuf, BUFFER_SIZE, &retCnt)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_writeInstrData (ViSession instrSession, 
                        ViString writeBuffer)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    
    if ((hpe1420b_status = viPrintf (instrSession, "%s", writeBuffer)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_readInstrData (ViSession instrSession, 
                        ViInt16 numBytes, ViChar rdBuf[], ViPInt32 bytesRead)
 {
    ViStatus hpe1420b_status = VI_SUCCESS;
    *bytesRead = 0L;
        
    if ((hpe1420b_status = viRead (instrSession, rdBuf, numBytes, bytesRead)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_reset (ViSession instrSession)
{
    ViUInt32 retCnt = 0;
    ViStatus hpe1420b_status = VI_SUCCESS;

    /*  Initialize the instrument to a known state.  */
    if ((hpe1420b_status = viWrite (instrSession, "*RST", 4, &retCnt)) < 0)
        return hpe1420b_status;
...
/*           the result.                                                     */
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_selfTest (ViSession instrSession, 
                        ViPInt16 testResult, ViChar testMessage[])
{
    ViUInt32 retCnt = 0;
    ViStatus hpe1420b_status = VI_SUCCESS;

    if ((hpe1420b_status = viWrite (instrSession, "*TST?", 5, &retCnt)) < 0)
        return hpe1420b_status;

    if ((hpe1420b_status = viScanf (instrSession, "%hd", testResult)) < 0)
        return hpe1420b_status;
...
/*           the result.                                                     */
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_errorQuery (ViSession instrSession, 
                        ViPInt32 errCode, ViChar errMessage[])
{
    ViUInt32 retCnt = 0;
    ViStatus hpe1420b_status = VI_SUCCESS;

    if ((hpe1420b_status = viWrite (instrSession, ":SYST:ERR?", 10, &retCnt)) < 0)
        return hpe1420b_status;

    if ((hpe1420b_status = viScanf (instrSession, "%ld,\"%[^\"]", errCode, errMessage)) < 0)
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_errorMessage (ViSession instrSession, 
                        ViStatus errorCode, ViChar errMessage[])
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViInt16 i;
    static hpe1420b_tStringValPair statusDescArray[] = {
...
/*        need to be inserted in the include file "hpe1420b.h".  The codes     */
...
/*===========================================================================*/
    ...
    hpe1420b_status = viStatusDesc (instrSession, errorCode, errMessage);
    if (hpe1420b_status == VI_WARN_UNKNOWN_STATUS) {
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_revisionQuery (ViSession instrSession,
                        ViChar driverRev[], ViChar instrRev[])
{
    ViUInt32 retCnt = 0;
    ViStatus hpe1420b_status = VI_SUCCESS;

    if ((hpe1420b_status = viWrite (instrSession, "*IDN?", 5, &retCnt)) < 0)
        return hpe1420b_status;

    if ((hpe1420b_status = viScanf (instrSession, "%*[^,],%*[^,],%*[^,],%[^\n]", instrRev)) < 0)
        return hpe1420b_status;

    strcpy (driverRev, hpe1420b_REVISION);
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_close (ViSession instrSession)
{
    hpe1420b_instrRange instrPtr;
    ViSession rmSession;
    ViStatus hpe1420b_status = VI_SUCCESS;

    if ((hpe1420b_status = viGetAttribute (instrSession, VI_ATTR_RM_SESSION, &rmSession)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viGetAttribute (instrSession, VI_ATTR_USER_DATA, &instrPtr)) < 0)
        return hpe1420b_status;
    
    /*- Disable Event SRQ ---------------------------------------------------*/
    if ((hpe1420b_status = viDisableEvent(instrSession, VI_EVENT_SERVICE_REQ, VI_QUEUE)) < 0) 
        return hpe1420b_status;
    
    free (instrPtr);
    
    hpe1420b_status = viClose (instrSession);
    viClose (rmSession);
...
/* Purpose:  This function is used only by the hpe1420b_init function.  When   */
/*           an error is detected this function is called to close the       */
/*           open resource manager and instrument object sessions and to     */
/*           set the instrSession that is returned from hpe1420b_init to       */
/*           VI_NULL.                                                        */
/*======================<<===================================================*/
ViStatus hpe1420b_initCleanUp (ViSession openRMSession,
...
/*===========================================================================*/
ViStatus hpe1420b_readToFile (ViSession instrSession, ViString filename,
    ...
    *retCount = 0L;
    ...
    for (;;) {
        if (readBytes > BUFFER_SIZE)
            hpe1420b_status = viRead (instrSession, buffer, BUFFER_SIZE, &bytesReadInstr);
        else
            hpe1420b_status = viRead (instrSession, buffer, readBytes, &bytesReadInstr);
        ...
        *retCount += bytesWrittenFile;
        if (bytesWrittenFile < bytesReadInstr)
            hpe1420b_status = VI_ERROR_FILE_WRITE; /* not defined by VTL */

        if ((readBytes <= BUFFER_SIZE) || (hpe1420b_status <= 0) || (hpe1420b_status == VI_SUCCESS_TERM_CHAR))
            break;
...
/*===========================================================================*/
ViStatus hpe1420b_writeFromFile (ViSession instrSession, ViString filename,
    ...
    *retCount = 0L;
    ...
    while (!feof (sourceFile)) {
        ...
        if ((writeBytes > BUFFER_SIZE) && (bytesRead == BUFFER_SIZE)) {
            ...
            hpe1420b_status = viWrite (instrSession, buffer, BUFFER_SIZE, &bytesWritten);
            viSetAttribute (instrSession, VI_ATTR_SEND_END_EN, sendEnd);
            writeBytes -= BUFFER_SIZE;
            *retCount += bytesWritten;
            if (hpe1420b_status < 0)
                break;
        }
        else {
            hpe1420b_status = viWrite (instrSession, buffer, ((bytesRead < writeBytes) ? bytesRead : writeBytes), &bytesWritten);
            *retCount += bytesWritten;
            break;
        }
    }
...
/*           function is called by the hpe1420b_reset operation and by the     */
/*           hpe1420b_init function if the reset option has not been           */
...
/*===========================================================================*/
ViStatus hpe1420b_defaultInstrSetup (ViSession instrSession)
{
    ViStatus hpe1420b_status = VI_SUCCESS;
    ViUInt32 retCnt = 0;
    
    hpe1420b_instrRange instrPtr;
    instrPtr = malloc (sizeof (struct hpe1420b_statusDataRanges));
...
/*===========================================================================*/
    ...
    instrPtr -> val2 = 0;
    instrPtr -> val3 = 0;
    strcpy (instrPtr -> instrDriverRevision, hpe1420b_REVISION);
    
    if (viSetAttribute (instrSession, VI_ATTR_USER_DATA, (ViUInt32)instrPtr) != 0)
        return hpe1420b_status;

    /*- Enable Event SRQ ----------------------------------------------------*/
    if ((hpe1420b_status = viEnableEvent(instrSession, VI_EVENT_SERVICE_REQ, VI_QUEUE, VI_NULL)) < 0) 
        return hpe1420b_status;
...
/*===========================================================================*/
ViStatus _VI_FUNC hpe1420b_waitForRqs (ViSession instrSession, 
                        ViInt32 timeout, ViInt16 *statusByte)
{
    ...
    if ((hpe1420b_status = viWaitOnEvent (instrSession, VI_EVENT_SERVICE_REQ, timeout, &eventType, &dupHandle)) < 0)
        return hpe1420b_status;
    if ((hpe1420b_status = viReadSTB (instrSession, statusByte)) < 0)
        return hpe1420b_status;
    hpe1420b_status = viClose (dupHandle);
