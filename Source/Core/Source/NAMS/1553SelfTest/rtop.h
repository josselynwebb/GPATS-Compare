...
_EXTERN S16BIT _DECL aceRTStkToHBuf32(S16BIT DevNum);
...
_EXTERN S16BIT _DECL aceRTRelatchAddr(S16BIT DevNum);

_EXTERN S16BIT _DECL aceRTAcquireAddress(S16BIT DevNum,
					 U16BIT *wRTAddr,
					 U16BIT wCANBus);
#endif
