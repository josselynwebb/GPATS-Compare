...
#define ACE_MT_DATASTK_512	0x0700	/* Cmd Stacks are 256 words */
#define ACE_MT_DATASTK_1K	0x0600	/* Cmd Stacks are 1K words */
#define ACE_MT_DATASTK_2K	0x0500	/* Cmd Stacks are 4K words */
#define ACE_MT_DATASTK_4K	0x0400	/* Cmd Stacks are 16K words */
#define ACE_MT_DATASTK_8K	0x0300	/* Cmd Stacks are 16K words */
#define ACE_MT_DATASTK_16K	0x0200	/* Cmd Stacks are 16K words */
#define ACE_MT_DATASTK_32K	0x0100	/* Cmd Stacks are 16K words */
...
_EXTERN S16BIT _DECL aceMTConfigure(S16BIT DevNum,
									U16BIT wMTStkType,
									U16BIT wCmdStkSize,
									U16BIT wDataStkSize,
									U32BIT dwOptions);
...
_EXTERN S16BIT _DECL aceMTISQRead(S16BIT DevNum,ISQENTRY *pISQEntry);
