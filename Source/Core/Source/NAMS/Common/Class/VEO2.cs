...
namespace VEO2_Library
{
    class VEO2
    {
        ...
        private readonly float laserEnergyCal1064 = CalFactor_Get(CAL1064);
        private readonly float laserEnergyCal1540 = CalFactor_Get(CAL1540);
        private readonly float laserEnergyCal1570 = CalFactor_Get(CAL1570);
        ...
        public double LaserEnergyCal1064
        {
            get
            {
        ...
        public double LaserEnergyCal1540
        {
            get
            {
        ...
        public double LaserEnergyCal1570
        {
            get
            {
        ...
        public int Mode_Set(int Mode)
        {
            ...
            if (Program.debugMode) { Debug.WriteDebugInfo("Setting VEO-2 Operating Mode to " + vMode); }
        ...
        /// <returns></returns>
        public int Sensor_Set(int CEPSA)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iCEPSA = -1;
            ...
            if (Program.debugMode) { Debug.WriteDebugInfo("Setting CEPSA to " + vCEPSA + " Position"); }
        ...
        public int Source_Set(int SSA)
        {
            ...
            if (Program.debugMode) { Debug.WriteDebugInfo("Setting SSA to " + vSSA + " Position"); }
        ...
        public int Target_Set(int TGT)
        {
            ...
            switch (TGT)
            {
                ...
                case 3:
                    vTarget = "5.00 Cyc/mrad 4 bar";
                    break;

                case 4:
                    vTarget = "3.8325 Cyc/mrad 4 bar";
                    break;

                case 5:
                    vTarget = "2.665 Cyc/mrad 4 bar";
                    break;

                case 6:
                    vTarget = "1.4975 Cyc/mrad 4 bar";
                    break;

                case 7:
                    vTarget = "0.33 Cyc/mrad 4 bar";
                    break;

                case 8:
                    vTarget = "Diagonal Slit";
                    break;

                case 9:
                    vTarget = "Multi Pinhole";
                    break;

                case 10:
                    vTarget = "Alignment Cross";
                    break;

                case 11:
                    vTarget = "USAF 1951, Groups 0-7";
                    break;

                case 12:
                    vTarget = "0.93 Cyc/mrad 4 bar";
                    break;

                case 13:
                    vTarget = "0.6122 Cyc/mrad 4 bar";
                    break;
            ...
            if (Program.debugMode) { Debug.WriteDebugInfo("Setting Target Wheel to " + vTarget + " Position"); }
        ...
        /// <returns></returns>
        public int LaserDiode_Set(int Diode)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iDiode = -1;
        ...
        /// <returns></returns>
        public int LaserTest_Set(int Operation)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iOp = -1;
        ...
        /// <param name="Source"></param>
        /// <returns></returns>
        public int LaserTrigger_Set(int Source)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iSource = -1;
        ...
        /// <param name="Operation"></param>
        /// <returns></returns>
        public int LaserOperation_Set(int Operation)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iOp = -1;
        ...
        public PulseWidthAttribues PulseWidth_Measure(int NumberMeasurements, int SCInputChannel, int SCInputRange, int SCTimebase, int SCTriggerSource, int SCTriggerSlope, float SCTriggerLevel)
        {
        ...
        public PulseEnergyAttributes PulseEnergy_Measure(int NumberMeasurements, int SCInputChannel, int SCInputRange, int SCTimebase, int SCTriggerSource, int SCTriggerSlope, float SCTriggerLevel, int Frequency)
        {
        ...
        /// <returns></returns>
        public int LARRS_AZ_Set(int Pos)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iPos = -1;
        ...
        /// <param name="Pos"></param>
        /// <returns></returns>
        public int LARRS_EL_Set(int Pos)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iPos = -1;
        ...
        /// <returns></returns>
        public int LARRS_Polarizer_Set(int Pos)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iPos = -1;
        ...
        /// <returns></returns>
        public int Radiance_Set(float Rad)
        {
            int iReturnValue = -1;
            int iTry = 0;
            float fRad = -1;
            ...
            while ((iTry <= 30) && ((Math.Abs(fRad - Rad)) > (Rad*0.01)))
            {
                System.Threading.Thread.Sleep(1000);
                try
                {
        ...
        /// <returns></returns>
        public int CameraPower_Set(int Op)
        {
            int iReturnValue = -1;
            int iTry = 0;
            int iOp = -1;
