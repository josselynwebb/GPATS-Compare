...
//
// Instrument:	Ri4152A  <device description> (DMM)
//
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
	...
	if(ResourceType==ATXMLW_RESTYPE_BASE)
	{
		...
		s_DevInfo[s_NumDev].DriverClass = new CRi4152A_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if(s_DevInfo[i].DriverClass != NULL)
            delete((CRi4152A_T *)(s_DevInfo[i].DriverClass));
                         ...
                         ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CRi4152A_T *)(DriverClass))->IssueSignalRi4152A(SignalDescription,
                            Response, BufferSize);
                         ...
                         ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CRi4152A_T *)(DriverClass))->StatusRi4152A(Response, BufferSize);
                         ...
                         ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    ((CRi4152A_T *)(DriverClass))->RegCalRi4152A(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
			if(s_DevInfo[i].DriverClass)
                ((CRi4152A_T *)(s_DevInfo[i].DriverClass))->ResetRi4152A(Response, BufferSize);
        }
    }
                         ...
                         int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CRi4152A_T *)(DriverClass))->IstRi4152A(Level, Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    Status = ((CRi4152A_T *)(DriverClass))->IssueNativeCmdsRi4152A(InstrumentCmds,
                            Response, BufferSize);
                         ...
                         ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CRi4152A_T *)(DriverClass))->IssueDriverFunctionCallRi4152A(DriverFunction,
                            Response, BufferSize);
