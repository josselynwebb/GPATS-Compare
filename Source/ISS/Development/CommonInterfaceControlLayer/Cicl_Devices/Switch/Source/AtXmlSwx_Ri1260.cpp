...
///////////////////////////////////////////////////////////////////////////
// File:	    AtXmlSwx_Ri1260.cpp
//
// Date:	    11OCT05
//
// Purpose:	    Instrument Driver for Swx_Ri1260
//
// Instrument:	Swx_Ri1260  Switch Processor (Switch)
//
...
ATXMLW_WRAP_FNC int Initialize(int Instno, int ResourceType, char* ResourceName, int Sim, int Dbglvl, ATXMLW_INSTRUMENT_ADDRESS *AddressInfoPtr, ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
    ...
    {
        // Only Initialize the first call which is the Base Controller
        return(0);
    }
    ...
    // Here you may want to spawn multiple classes for "Physical Resources" etc.
    /*
    CSwx_Ri1260_T(int Instno, int ResourceType, char* ResourceName,
                               int Sim, int Dbglvl,
                               ATXMLW_INSTRUMENT_ADDRESS *AddressInfoPtr,
                               ATXMLW_INTF_RESPONSE* Response, int Buffersize);
                               */

    s_DevInfo[s_NumDev].DriverClass = new CSwx_Ri1260_T(
	...
	// Calleset to close default switches
	if(s_DevInfo[s_NumDev].DriverClass)
	{
		((CSwx_Ri1260_T *)s_DevInfo[s_NumDev].DriverClass)->ResetSwx_Ri1260(Response, Buffersize);
	}

    s_NumDev++;

//	CoInitialize(NULL);	// Used by the Wrapper library for Xml Parsing
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
		...
		{
            delete((CSwx_Ri1260_T *)(s_DevInfo[i].DriverClass));
		}
...
ATXMLW_WRAP_FNC int IssueSignal(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_SIGDESC* SignalDescription, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CSwx_Ri1260_T *)(DriverClass))->IssueSignalSwx_Ri1260(SignalDescription, Response, BufferSize);
...
//
///////////////////////////////////////////////////////////////////////////////
ATXMLW_WRAP_FNC int Status(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    int   i;
    char  cInstNo[20];
    void *DriverClass = NULL;
    ...
    ((CSwx_Ri1260_T *)(DriverClass))->StatusSwx_Ri1260(Response, BufferSize);
...
ATXMLW_WRAP_FNC int RegCal(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_CALDATA* CalData)
{
    ...
    ((CSwx_Ri1260_T *)(DriverClass))->RegCalSwx_Ri1260(CalData);
...
ATXMLW_WRAP_FNC int Reset(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        {
            DriverClass = (void *)(s_DevInfo[i].DriverClass);
            ((CSwx_Ri1260_T *)(DriverClass))->ResetSwx_Ri1260(Response, BufferSize);
        }
    }
...
ATXMLW_WRAP_FNC int Ist(int Instno, int ResourceType, char* ResourceName, int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    ((CSwx_Ri1260_T *)(DriverClass))->IstSwx_Ri1260(Level, Response, BufferSize);
...
ATXMLW_WRAP_FNC int IssueNativeCmds(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_INSTCMD* InstrumentCmds, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    Status = ((CSwx_Ri1260_T *)(DriverClass))->IssueNativeCmdsSwx_Ri1260(InstrumentCmds, Response, BufferSize);
...
ATXMLW_WRAP_FNC int IssueDriverFunctionCall(int Instno, int ResourceType, char* ResourceName, ATXMLW_INTF_DRVRFNC* DriverFunction, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    ((CSwx_Ri1260_T *)(DriverClass))->IssueDriverFunctionCallSwx_Ri1260(DriverFunction, Response, BufferSize);
