...
//
// Instrument:	TerM9  Digital Device (DTI_1)
//
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
    ...
    if(ResourceType == ATXMLW_RESTYPE_BASE)
    {
        ...
        s_DevInfo[s_NumDev].DriverClass = new CTerM9_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if(s_DevInfo[i].DriverClass != NULL)
            delete((CTerM9_T *)(s_DevInfo[i].DriverClass));
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->IssueSignalTerM9(SignalDescription,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->StatusTerM9(Response, BufferSize);
                               ...
                               ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->RegCalTerM9(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
            if(s_DevInfo[i].DriverClass)
                ((CTerM9_T *)(s_DevInfo[i].DriverClass))->ResetTerM9(Response, BufferSize);
        }
    }
                        ...
                        int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->IstTerM9(Level, Response, BufferSize);
                                  ...
                                  ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->IssueNativeCmdsTerM9(InstrumentCmds,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CTerM9_T *)(DriverClass))->IssueDriverFunctionCallTerM9(DriverFunction,
                            Response, BufferSize);
