...
//
// Instrument:	HPE1428A  <device description> (DSO)
//
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
	...
	if (ResourceType == ATXMLW_RESTYPE_BASE)
	{
		...
		s_DevInfo[s_NumDev].DriverClass = new CHPE1428A_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if(s_DevInfo[i].DriverClass != NULL)
            delete((CHPE1428A_T *)(s_DevInfo[i].DriverClass));
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    //((CHPE1428A_T *)(DriverClass))->IssueSignalHPE1428A(SignalDescription,
    //                        Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CHPE1428A_T *)(DriverClass))->StatusHPE1428A(Response, BufferSize);
                               ...
                               ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    //((CHPE1428A_T *)(DriverClass))->RegCalHPE1428A(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
			if(s_DevInfo[i].DriverClass)
				((CHPE1428A_T *)(s_DevInfo[i].DriverClass))->ResetHPE1428A(Response, BufferSize);
        }
    }
                        ...
                        int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    //((CHPE1428A_T *)(DriverClass))->IstHPE1428A(Level, Response, BufferSize);
                                  ...
                                  ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    Status = ((CHPE1428A_T *)(DriverClass))->IssueNativeCmdsHPE1428A(InstrumentCmds,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CHPE1428A_T *)(DriverClass))->IssueDriverFunctionCallHPE1428A(DriverFunction,
                            Response, BufferSize);
