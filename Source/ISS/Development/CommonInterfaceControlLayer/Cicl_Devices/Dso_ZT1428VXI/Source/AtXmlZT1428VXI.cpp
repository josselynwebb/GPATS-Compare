...
//
// Instrument:	ZT1428VXI  <device description> (DSO)
//
...
ATXMLW_WRAP_FNC int Initialize(int Instno, int ResourceType, char* ResourceName, int Sim, int Dbglvl, ATXMLW_INSTRUMENT_ADDRESS *AddressInfoPtr, ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
	...
	if (ResourceType == ATXMLW_RESTYPE_BASE)
	{
		...
		s_DevInfo[s_NumDev].DriverClass = new CZT1428VXI_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if(s_DevInfo[i].DriverClass != NULL)
            delete((CZT1428VXI_T *)(s_DevInfo[i].DriverClass));
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CZT1428VXI_T *)(DriverClass))->IssueSignalZT1428VXI(SignalDescription,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CZT1428VXI_T *)(DriverClass))->StatusZT1428VXI(Response, BufferSize);
                               ...
                               ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    ((CZT1428VXI_T *)(DriverClass))->RegCalZT1428VXI(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
			if(s_DevInfo[i].DriverClass)
				((CZT1428VXI_T *)(s_DevInfo[i].DriverClass))->ResetZT1428VXI(Response, BufferSize);
        }
    }
                        ...
                        int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CZT1428VXI_T *)(DriverClass))->IstZT1428VXI(Level, Response, BufferSize);
                                  ...
                                  ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    Status = ((CZT1428VXI_T *)(DriverClass))->IssueNativeCmdsZT1428VXI(InstrumentCmds,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CZT1428VXI_T *)(DriverClass))->IssueDriverFunctionCallZT1428VXI(DriverFunction,
                            Response, BufferSize);
