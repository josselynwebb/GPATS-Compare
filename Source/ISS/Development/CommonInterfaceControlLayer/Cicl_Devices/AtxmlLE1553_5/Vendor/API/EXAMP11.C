...
/**
*
*  CM1553-3 DRIVER EXAMPLE 11  Version 1.0  (07/16/2001)
...
void main(void)
{
	...
	fprintf(stderr,"\nEXAMP11  Version 1.0  (07/16/2001)");
...
**/
	...
	BCList = C13_BCCreateList(LISTCRT_FIFO,100,MSGCRT_DEFAULT,CMD,0,NULL,Card);
...
**/
	...
	do
	{
		...
		Result = C13_ListDataWr(Data,32,BCList,Card);
		++Data[0];
	} while(Result);
