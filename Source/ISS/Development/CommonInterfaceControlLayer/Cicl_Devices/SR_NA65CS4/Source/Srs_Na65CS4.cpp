...
///////////////////////////////////////////////////////////////////////////
// File:	    Srs_Na65CS4.cpp
//
// Date:	    11OCT05
//
// Purpose:	    Instrument Driver for Srs_Na65CS4
//
// Instrument:	Srs_Na65CS4  <device description> (DMM)
//
        ...
        ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
    ...
    if (ResourceType == ATXMLW_RESTYPE_BASE)
    {
        ...
        s_DevInfo[s_NumDev].DriverClass = new CSrs_Na65CS4_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if (s_DevInfo[i].DriverClass != NULL)
            delete((CSrs_Na65CS4_T *)(s_DevInfo[i].DriverClass));
...
ATXMLW_WRAP_FNC int RegisterTSF(ATXMLW_XML_FILENAME* TSFSignalDefinition, 
        ATXMLW_XML_FILENAME* TSFLibrary, ATXMLW_XML_FILENAME* STDTSF,
...
ATXMLW_WRAP_FNC int IssueSignal(int Instno, int ResourceType, char* ResourceName,
        ATXMLW_INTF_SIGDESC* SignalDescription, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    int i;
    char  cInstNo[20];
    ...
    // 
    ((CSrs_Na65CS4_T *)(DriverClass))->IssueSignalSrs_Na65CS4(SignalDescription,
                            Response, BufferSize);
        ...
        ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CSrs_Na65CS4_T *)(DriverClass))->StatusSrs_Na65CS4(Response, BufferSize);
        ...
        ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    ((CSrs_Na65CS4_T *)(DriverClass))->RegCalSrs_Na65CS4(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if ((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
			if(s_DevInfo[i].DriverClass)
				((CSrs_Na65CS4_T *)(s_DevInfo[i].DriverClass))->ResetSrs_Na65CS4(Response, BufferSize);
        }
    }
        ...
        int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CSrs_Na65CS4_T *)(DriverClass))->IstSrs_Na65CS4(Level, Response, BufferSize);
...
ATXMLW_WRAP_FNC int IssueNativeCmds(int Instno, int ResourceType, char* ResourceName,
        ATXMLW_INTF_INSTCMD* InstrumentCmds, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    int i;
    char  cInstNo[20];
    void *DriverClass = NULL;
    ...
    // 
    Status = ((CSrs_Na65CS4_T *)(DriverClass))->IssueNativeCmdsSrs_Na65CS4(InstrumentCmds,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CSrs_Na65CS4_T *)(DriverClass))->IssueDriverFunctionCallSrs_Na65CS4(DriverFunction,
                            Response, BufferSize);
