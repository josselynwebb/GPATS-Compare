...
///////////////////////////////////////////////////////////////////////////
// File:	    Arb_AgE1445A.cpp
//
// Date:	    20JAN06
//
// Purpose:	    Instrument Driver for AgE1445A
//
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int Buffersize)
{
    ...
    if (DE_BUG == 0) {
		sprintf(TmpBuf, "%s", DEBUG_1445Arb);
    ...
    if(ResourceType == ATXMLW_RESTYPE_BASE)
    {
        ...
        s_DevInfo[s_NumDev].DriverClass = new CArb_AgE1445A_T(
...
ATXMLW_WRAP_FNC int Close(void)
{
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        if(s_DevInfo[i].DriverClass != NULL)
            delete((CArb_AgE1445A_T *)(s_DevInfo[i].DriverClass));
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CArb_AgE1445A_T *)(DriverClass))->IssueSignalArb_AgE1445A(SignalDescription,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CArb_AgE1445A_T *)(DriverClass))->StatusArb_AgE1445A(Response, BufferSize);
                               ...
                               ATXMLW_INTF_CALDATA* CalData)
{
    ...
    // 
    ((CArb_AgE1445A_T *)(DriverClass))->RegCalArb_AgE1445A(CalData);
    ...
    for(i = 0; i < s_NumDev; i++)
    {
        ...
        if((Instno == 0) || (s_DevInfo[i].InstNo == Instno))
        {
			if(s_DevInfo[i].DriverClass)
				((CArb_AgE1445A_T *)(s_DevInfo[i].DriverClass))->ResetArb_AgE1445A(Response, BufferSize);
        }
    }
                        ...
                        int Level, ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CArb_AgE1445A_T *)(DriverClass))->IstArb_AgE1445A(Level, Response, BufferSize);
                                  ...
                                  ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    Status = ((CArb_AgE1445A_T *)(DriverClass))->IssueNativeCmdsArb_AgE1445A(InstrumentCmds,
                            Response, BufferSize);
                               ...
                               ATXMLW_INTF_RESPONSE* Response, int BufferSize)
{
    ...
    // 
    ((CArb_AgE1445A_T *)(DriverClass))->IssueDriverFunctionCallArb_AgE1445A(DriverFunction,
                            Response, BufferSize);
