...
// Date:	    26JUN06
//
// Purpose:	    Instrument Driver for Can_TDR010
//
// Instrument:	Can_TDR010  <device description> (<device type>)
//
//
// Revision History described in Can_T.cpp
// 1.0.0.0  30MAY19  'CAN" Channel Problem         JWitcher
//
///////////////////////////////////////////////////////////////////////////////
#include "CAN.h"
...
private:
	...
	AttributeStruct m_Channel1;
	AttributeStruct m_Channel2;
	AttributeStruct m_Attribute;
	char m_Data[MAX_DATA];
	//char m_RetData[MAX_DATA];
	//CJW removed unsigned char* m_RetData;
	// CJW resotred
	AttributeStruct m_ListenOnly;
	AttributeStruct m_TalkerListenerBits;
	UCHAR m_RetData[MAX_DATA];


public:
     CCan_TDR010_T(int Instno, int ResourceType, char* ResourceName,
                               int Sim, int Dbglvl,
