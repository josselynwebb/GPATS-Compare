Public Class DPSTArray
    Private _count As Integer = 0
    Private _columns As Integer = 0
    Private _rows As Integer = 0
    Private Const SWITCH_WIDTH = 96
    Private Const SWITCH_HEIGHTH = 36
    Private _switches(,) As DPST
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property Switches(ByVal index As Integer) As SwitchLib.DPST
        Get
            Dim c, r As Integer
        ...
        End Get
        Private Set(value As SwitchLib.DPST)
        End Set
    End Property
