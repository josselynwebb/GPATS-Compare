Public Class ctl2W1RowArray
    Private _count As Integer = 0
    Private Const SWITCH_WIDTH = 36
    Private _switches() As ctl2W1Row
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property Switches(ByVal index As Integer) As SwitchLib.ctl2W1Row
        Get
            Return _switches(index)
        End Get
        Private Set(value As SwitchLib.ctl2W1Row)
        End Set
    End Property
