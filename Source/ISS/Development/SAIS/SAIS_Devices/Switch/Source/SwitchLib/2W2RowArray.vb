Public Class ctl2W2RowArray
    Private _count As Integer = 0
    Private Const SWITCH_WIDTH = 36
    Private _switches() As ctl2W2Row
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property Switches(ByVal index As Integer) As SwitchLib.ctl2W2Row
        Get
            Return _switches(index)
        End Get
        Private Set(value As SwitchLib.ctl2W2Row)
        End Set
    End Property
