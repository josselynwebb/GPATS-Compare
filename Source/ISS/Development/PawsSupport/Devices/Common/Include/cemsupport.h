...
extern void			cs_array_to_bin_string(int array [], int size, int length, char output []);

extern void			cs_bin_string_to_array(char input [], int length, int array [], int * size);
#endif
